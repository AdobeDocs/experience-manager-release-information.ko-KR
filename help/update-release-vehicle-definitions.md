...
| 설명서 | <ul> <li> 릴리스 노트는 설명서 포털에 있습니다. </li> <li> 기능, 개선 사항 및 버그 수정에 대한 설명서는 설명서 포털에 있습니다 </li> </ul> |
| 케이던스 | 연간 |
| 가용성 및 설치 | <ul> <li> 독립 실행형 제품 설치 프로그램으로 제공됨 </li> <li>  라이센스 웹 사이트 및 Managed Services를 통해 제공 </li> <li> 웹 사이트 사용권 지정 시 컨텐츠 저장소 마이그레이션이 필요할 수 있음 </li> </ul> |
...
| 설명서 | <ul> <li> 설명서 포털에 있는 릴리스 노트 </li> <li> 설명서 포털의 기능, 개선 사항, 버그 수정 사항 설명서 </li> </ul> |
| 케이던스 | 분기별 |
