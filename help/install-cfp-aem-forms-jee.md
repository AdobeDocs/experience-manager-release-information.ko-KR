...
AEM 6.3에 누적 수정 팩을 설치하려면 다음을 수행하십시오 [!DNL Forms JEE]를 채우기 위해 다음 단계 시퀀스를 수행합니다.

1. AEM 6.3을 얻으려면 [!DNL Forms JEE] cfp 설치 관리자가 [Adobe 지원](https://experienceleague.adobe.com/?support-solution=General&amp;support-tab=home#support).
...
AEM [!DNL  Forms JEE] 패키지 (aemfd-jee-bundles-package-6.3CFP1; 버전 1.0.2) 제공 [!DNL Forms] AEM의 사용자 [!DNL Forms JEE] AEM에 있는 것과 동일한 권한 및 기능 [!DNL Forms OSGi]. 패키지 관리자에서 설치된 패키지를 확인하고 아직 설치하지 않은 경우 패키지를 설치합니다.
...
AEM 6.2에 누적 수정 팩을 설치하려면 다음을 수행하십시오 [!DNL Forms JEE]를 채우기 위해 다음 단계 시퀀스를 수행합니다.

1. AEM 6.2를 얻으려면 [!DNL Forms JEE] cfp 설치 관리자가 [Adobe 지원](https://experienceleague.adobe.com/?support-solution=General&amp;support-tab=home#support).
...
AEM Forms JEE 패키지 (aemfd-jee-bundles-package-6.2CFP5; 버전 1.0.2) 제공 [!DNL Forms] AEM의 사용자 [!DNL Forms JEE] AEM에 있는 것과 동일한 권한 및 기능 [!DNL Forms OSGi]. 패키지 관리자에서 설치된 패키지를 확인하고 아직 설치하지 않은 경우 패키지를 설치합니다.
...
DSC 배포의 소요 시간은 달라질 수 있어 실패의 원인이 됩니다. 설치, 로드, 시작, 중지 등의 DSC 작업에 대한 시간 제한을 변경하려면 `adobe.component.registry.timeout` -D 옵션과 함께 JVM 인수 사용.
...
1. 를 설정하려면 `DSC operations`로드 및 설치 등과 같이 600초까지는 다음을 사용합니다.
...
1. 설치 폴더 선택 화면에서 표시되는 기본 위치가 기존 설치에 맞는지 확인하거나 을 클릭합니다 **[!UICONTROL 찾아보기]** AEM이 있는 대체 폴더를 선택하려면 [!DNL Forms] 이 설치되어 있고 **[!UICONTROL 다음]**.
