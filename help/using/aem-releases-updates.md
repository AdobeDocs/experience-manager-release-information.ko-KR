...
[!DNL Experience Manager] 6.5 제품 업데이트는 서비스 팩을 통해 제공되며 새로운 기능, 개선 사항 및 버그 수정이 포함됩니다.
...
[!DNL Experience Manager] 6.5 LTS 제품 업데이트는 서비스 팩을 통해 제공되며 새로운 기능, 개선 사항 및 버그 수정이 포함됩니다.
