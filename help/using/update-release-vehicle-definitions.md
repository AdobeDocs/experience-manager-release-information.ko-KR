...
description: 이 문서에서는 의 다양한 유형에 대해 자세히 설명합니다. [!DNL Experience Manager] 전체 릴리스, 기능 팩 및 서비스 팩이 포함된 릴리스.
contentOwner: AK
...
| 케이던스 | 연간 |
| 가용성 및 설치 | <ul> <li> 독립 실행형 제품 설치 프로그램으로 제공됨 </li> <li>  라이선싱 웹 사이트 및 Managed Services를 통해 제공 </li> <li> 웹 사이트 사용권 지정 시 콘텐츠 저장소 마이그레이션이 필요할 수 있음 </li> </ul> |
...
| 설명서 | <ul> <li> 설명서 포털에 있는 릴리스 정보 </li> <li> 설명서 포털의 기능, 개선 사항, 버그 수정 사항 설명서 </li> </ul> |
| 케이던스 | 분기별 |
| 가용성 및 설치 | <ul> <li> 패키지로 제공 </li> <li> 소프트웨어 배포 시 제공</li> <li>  기존 기능 설치 필요 </li> </ul> |
...
| 항목 | 설명 |
|-----|-----|
| 정의 | <ul> <li> 수정 사항 릴리스의 단일 전달 모델 </li> <li> 개별 구성 요소의 콘텐츠 패키지를 포함하는 누적 콘텐츠 패키지 </li> <li>  CFP는 핫픽스를 롤오버하고 있으며 그 일부에는 향상된 기능이 없습니다.  </li> </ul> |
...
* 1: Oak 수정 사항은 개별 핫픽스로 제공되지 않습니다. 하지만 후속 누적 Oak 핫픽스에 포함됩니다. 필요한 경우 최신 COFP 위에 구축된 진단을 사용할 수 있습니다. 전제 조건은 고객의 최신 COFP가 실행 중인 것입니다. 진단 빌드는 핫픽스와 동일한 수준의 품질 보증만 제공합니다. 따라서 누적 수정 팩, 서비스 팩 또는 제품 릴리스만큼의 품질 보증을 제공하지 않습니다. 최종 수정 내용은 다음 CFP와 함께 제공됩니다.
