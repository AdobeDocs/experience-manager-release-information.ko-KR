...
description: AEM 6.2 누적 수정 팩 릴리스 정보에 대해 자세히 알아보십시오.
...
| **전제 조건** | [AEM 6.2 서비스 팩 1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) |
| **일반 출시** | 2019년 6월 6일 |
...
CFP 및 기타 릴리스 유형에 대한 자세한 내용은 [유지 관리 릴리스 수단](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)을 참조하십시오.

## 릴리스 정보 {#about-the-release}

AEM 누적 수정 팩 6.2 SP1-CFP20은 AEM 6.2의 마지막 누적 수정 팩이며 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항이 포함된 중요한 업데이트입니다.
...
>
>* **com.day.commons.osgi.wrapper/com.day.commons.osgi.wrapper.commons-email/1.2.0-0002**&#x200B;를 교체하는 Apache commons **org.apache.commons/commons-email/1.5**&#x200B;의 이메일 번들이 추가되었습니다.
>
...
* 여러 캠페인 타겟팅 개인화 개선 사항을 지원합니다. NPR-29163: CQ-4264126용 핫픽스
...
* 편지를 PDF으로 미리 볼 때 기본 페이지에 배치된 텍스트 필드에 데이터 탭에서 입력한 값이나 지정된 데이터 링크 내용이 적용되지 않습니다. NPR-29239: CQ-4266856용 핫픽스.
...
AEM 누적 수정 팩 6.2 SP1-CFP19는 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항을 포함하는 중요한 업데이트입니다.
...
* `cq:actions`는 타겟팅된 구성 요소에서 고려하지 않습니다. NPR-27616: CQ-4257497용 핫픽스
...
* `sling:basename`을 사용하는 리소스 번들에 대한 사전은 무효화되지 않습니다. NPR-27624
...
다음 텍스트 문서에는 CFP에 포함된 OSGi 번들 및 콘텐츠 패키지 목록이 기재되어 있습니다.
...
AEM 누적 수정 팩 6.2 SP1-CFP18은 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항을 포함하는 중요한 업데이트입니다.
...
* 코어 페이지 구성 요소에 리디렉션 지원을 추가합니다. NPR-26576: CQ-110529용 핫픽스
...
* 원하지 않는 텍스트를 삽입하는 텍스트를 복사하여 붙여넣기 &lt;br> 콘텐츠 조각 내. NPR-26660: CRTE-151용 핫픽스
* 클래식 사이트 관리자는 일부 페이지의 오른쪽 창에 있는 목록을 렌더링하지 않습니다. NPR-27247: CQ-4251621용 핫픽스
* (클래식 UI) 페이지 이동/이름 변경을 시도하면 “페이지 이동 중 오류가 발생합니다.”라는 오류가 발생합니다. NPR-27179: CQ-4235907용 핫픽스
...
* AEM Forms 추가 기능 패키지에서 새로운 수정 사항이 없습니다.
...
AEM 누적 수정 팩 6.2 SP1-CFP17은 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항을 포함하는 중요한 업데이트입니다.
...
* 자산 UI에서 워크플로를 시작하려면 사용자에게 쓰기/삭제/수정 권한이 있어야 합니다. NPR-25688: CQ-4250140용 핫픽스
* 복제 권한이 없는 사용자에게도 게시 및 게시 취소 버튼이 계속 표시됩니다. NPR-25094
* (워크플로) 스마트 태그 자산 워크플로는 AEM 프록시 구성을 통해 처리되지 않습니다. NPR-25915: CQ-4248202용 핫픽스
...
* (클래식 UI) Live Copy 아래에 독립형 페이지를 만들 때 페이지가 Live Copy로 생성됩니다. NPR-25610: CQ-4249801용 핫픽스
* 페이지가 활성화될 때 디자인 Importer 구성 요소와 연관된 리소스를 게시하는 데 관련된 문제 NPR-25638: CQ-102532용 핫픽스
* RTE 리치 텍스트 편집기 도구 모음은 선택 목록을 다룹니다. NPR-25165: CQ-4248948용 핫픽스
* 컨텍스트 허브를 jQuery 3으로 마이그레이션합니다. NPR-25059: Granite-19902용 핫픽스
* 중첩된 Parsys 구성 요소의 경우, 사용 가능한 여러 구성 요소에서 항상 첫 번째로 만족스러운 디자인(중첩된 경로가 가장 적게 있음)을 적용합니다. 자세한 내용은 [디자인 경로 해상도](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)를 참조하십시오. NPR-25250: CQ-4246276용 핫픽스

### 통합 {#integration-3}

* OOTB 타겟 통합을 사용하여 구성 요소를 타깃팅하면 빈 타깃팅된 구성 요소 대신 전체 페이지가 렌더링됩니다. NPR-25273: CQ-4248003용 핫픽스
...
* cq-social-as-provider 번들은 Mongo 드라이버 3.x 버전으로 시작하지 않습니다. NPR-26271: CQ-4252710용 핫픽스
...
#### Forms - 관리 {#forms-management}

* 페이지를 게시하는 동안 관련 없는 양식 자산이 참조로 보고되었습니다. NPR-26167: CQ-4251004용 핫픽스
...
AEM 누적 수정 팩 6.2 SP1-CFP16은 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항을 포함하는 중요한 업데이트입니다.
...
* XSS(크로스 사이트 스크립팅) 공격에 대한 사전 예방적 핫픽스. NPR-21893: CQ-4223385용 핫픽스
* MSM LiveRelationship: BlueprintConfig가 루트에 있는 경우 유효 RolloutConfig가 잘못되었습니다. NPR-23999: CQ-4243000용 핫픽스

### 사이트 {#sites-3}

* Live Copy 영역에서 경험을 만들려면 먼저 상속을 중단해야 구성할 수 있습니다. NPR-24995, CQ-4248209용 핫픽스
* (Touch UI) 페이지를 잠그거나 잠금 해제할 때 상단 도구 모음에 있는 여러 개의 아이콘이 사라집니다. NPR-23954: CQ-4243345용 핫픽스
* 이 필드가 컨텍스트 허브에서 올바르게 정렬되지 않습니다. NPR-23958
* 잠긴 페이지의 Publish 작업을 수행하면 작성이 중단됩니다. NPR-23970: CQ-4243203용 핫픽스
* /etc/reports/의 OOTB 보고서가 제대로 작동하지 않고 내역 데이터 그래프가 표시되지 않습니다. NPR-20035: CQ-4220180용 핫픽스
* 프로젝트에서 &#39;실행 요청&#39; 워크플로우를 시작하는 동안 Launch 만들기가 실패합니다. NPR-24255: CQ-4245030용 핫픽스
...
* 기본 미리 보기를 통해 편지를 미리 보면 레이아웃 조각 매핑이 표시되지 않지만 [미리 보기]를 클릭할 때는 동일한 페이지가 올바르게 표시됩니다. NPR-22993: CQ-4237745용 핫픽스
...
AEM 누적 수정 팩 6.2 SP1-CFP15는 [AEM 6.2 SP1](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 일반 공급 이후 릴리스된 주요 고객 수정 사항을 포함하는 중요한 업데이트입니다.

이 누적 수정 팩의 주요 사항은 다음과 같습니다.

* 디자인 일관성을 유지하기 위해 Foundation 테이블의 사전 보안 수정 사항
* 값을 문자열로 저장하도록 typeHint 지원 추가
* Forms 미리 채우기 서비스에 대한 보안 개선
* 판독기 확장의 수정 사항에 대해 최신 adobe-reader-extensions-dsc.jar 파일로 업데이트합니다.
...
* 큰 값(10000000000)으로 세그먼트를 저장하면 증폭이 0으로 설정되어 오류 메시지가 표시됩니다. NPR-22524: CQ-4237006용 핫픽스
* 다중 필드 구성 요소에서 항목 추가를 클릭할 수 없습니다. NPR-22552: CQ-4237404용 핫픽스
* 세그먼트에 긴 제목이 있으면 가로 스크롤 막대가 표시되지 않습니다. NPR-22615: CQ-4237001용 핫픽스
* 빈 대상자를 로드하면 잘못된 JavaScript 코드가 생성됩니다. NPR-22974: CQ-4238734용 핫픽스
...
* AEM 6.0에서 AEM 6.2로 구성 요소를 마이그레이션하는 중 &#39;올바르지 않은 재귀 선택기 값&#39; 오류가 발생합니다. NPR-23503: CQ-4241258용 핫픽스

### 커뮤니티 {#communities-1}

* 메시지 오류로 인해 웹 및 메일 알림이 그룹으로 트리거되지 않습니다. NPR-23447: CQ-4242880용 핫픽스
...
* DatePicker는 숨겨진 필드에 설정된 외부 유형 힌트를 수동으로 설정할 수 없습니다. 이 유형 힌트를 변경하면 변환 오류가 발생합니다. NPR-23333: Granite-21194용 핫픽스

### WCM - Foundation 구성 요소 {#wcm-foundation-components-2}

* CAPTCHA 구성 요소는 이제 보안 강화를 위해 더 이상 사용되지 않습니다. CAPTCHA 구성 요소를 사용하는 경우 6.2 SP2-CFP15 이상 릴리스를 설치하면 &quot;Captcha 구성 요소는 더 이상 사용되지 않으며 사용해서는 안 됩니다&quot;라는 메시지가 표시됩니다. 보안 강화를 위해 reCAPTCHA를 포함하도록 AEM 구성 요소를 사용자 정의할 수 있습니다. NPR-22151: CQ-4220052용 핫픽스
* WCM Foundation 구성 요소 &#39;Table&#39;은 저장된 크로스 사이트 스크립팅에 취약합니다. NPR-23206: CQ-4240760용 핫픽스
...
* 기본 미리 보기를 통해 편지를 미리 보는 경우 레이아웃 조각 매핑이 표시되지 않지만 [미리 보기] 단추를 클릭할 때는 레이아웃 조각 매핑이 올바르게 표시됩니다. NPR-23335: CQ-4237745용 핫픽스
...
* Adobe PDF에서 Reader 확장 기능을 적용할 수 없습니다. NPR-23067
...
* (OSGI) [JEE] &quot;PDF 확인 프로세스&quot;를 사용하여 확인하는 동안 첨부 파일이 있는 PDF에 대한 잘못된 서명 상태가 있습니다. NPR-23269, NPR-23737
...
### OSGi 번들 및 콘텐츠 패키지 포함됨 {#osgi-bundles-and-content-packages-included-4}
...
* Safari의 자산에서 Digital Rights Management를 사용할 때 자산 다운로드가 실패합니다. NPR-22378: CQ-4236460용 핫픽스
...
* (Touch UI) 리치 텍스트 편집기가 &lt;a> 태그에서 ID 이외의 모든 속성을 제거합니다. NPR-22045: CQ-4234133용 핫픽스
...
* (Digital Publishing Suite) Folio를 DPS에 업로드하기 전에 게시일 및 표지 날짜 필드를 모두 필수 필드로 사용해야 합니다. NPR-22484
...
* Live Copy의 다른 필드를 편집할 때 `cq:cugEnabled` 속성이 비활성화되므로 페이지가 보호되지 않습니다. NPR-22246: CQ-4236050용 핫픽스
* 페이지가 일시 중단되면 페이지 롤아웃 작업에서 하위 페이지가 업데이트되지 않습니다. NPR-22483: CQ-4236956용 핫픽스
* 기본 리드인 구조에서 이동된 구조를 롤아웃하면 오류가 발생합니다. `cq:moveTarget`. NPR-22373: CQ-4232536용 핫픽스
...
* (HTML Workspace) 사용자가 작업을 요청하면 해당 특정 사용자에 대한 큐 개수를 새로 고칩니다. 즉, 페이지를 새로 고치지 않는 한 입니다. NPR-19778: CQ-4233665용 핫픽스
...
* 버전 삭제에서 이전 버전의 자산을 제거하지 못했습니다. NPR-21682: CQ-4212996용 핫픽스
...
* 편집기에서 페이지를 로드할 때 WorkflowStatusprovider(pageinfo.json)가 3번 로드되어 AEM 인스턴스가 느리게 실행됩니다. NPR-21778: CQ-59232용 핫픽스

### 통합 {#integration-7}

* 모바일 유형 및 브라우저의 대상자 만들기가 AEM에서 Target 작성 모드로 작동하지 않습니다. NPR-21676, NPR-21681: CQ-4232100용 핫픽스
* 타겟팅된 구성 요소를 새로 고치는 동안 지연 시간이 길어지는 중 구성 요소를 완전히 새로 고치기 전에 다른 오퍼를 추가할 수 있습니다. NPR-21744: CQ-4233158/CQ-4234293용 핫픽스
...
* 사용자는 Sling 배포를 사용하여 사용자 동기화와 동기화할 수 없습니다. NPR-21911: Granite-20404용 핫픽스
* Geometrixx 페이지의 검색 발췌 시 중지 단어가 강조 표시되지 않습니다. NPR-21835: Granite-21067용 핫픽스
참고: 이 수정 사항을 적용하려면 Oak CFP 1.4.20 이상이 필요합니다.

### 번역 {#translation-3}

* 번역 프로젝트를 만드는 동안 개시자 사용자 ID에 대한 jcr 속성이 누락되었습니다. NPR-21715: CQ-4230713용 핫픽스
...
* `6.2.0-ASM-1017-003`을 사용하여 생성된 PDF 파일이 손상되었습니다. NPR-21427: CQ-4228046용 핫픽스
...
* AEM과 Adobe Digital Publishing Suite 간 자산에 대한 게시 날짜 동기화를 개선했습니다.
...
* Safari의 자산에서 Digital Rights Management를 사용할 때 자산 다운로드가 실패합니다. NPR-21387: CQ-4230287용 핫픽스
...
* AEM 6.3으로 업그레이드한 후 스크립트로 구현된 태그를 참조하는 사용자 지정 태그 라이브러리를 찾을 수 없습니다. NPR-20149: Granite-18433용 핫픽스
...
* HTTP.encodePathOfURI가 확장되면 더하기 &#39;+&#39; 기호를 두 번 인코딩합니다. NPR-21417: GRANITE-16340용 핫픽스

### 취약성 {#vulnerability-4}

* DAM 메타데이터 편집기의 XSS(크로스 사이트 스크립팅). NPR-21434: CQ-83472용 핫픽스
* 여러 SWF 파일은 XSS(크로스 사이트 스크립팅)에 취약합니다. NPR-20612: CQ-4213297용 핫픽스
...
**참고:** 이 NPR에는 추가 설정이 필요합니다. [최신 Java™ 8 업데이트](#latest-java-update-throws-an-exception-npr)를 참조하십시오.
...
* Jsafe Jars가 RE에서 CryptoJ 6.1.3.1로 업데이트되었습니다. NPR-21357
...
* `org.apache.sling.i18n.DefaultLocaleResolver` 은 org.apache.sling.engine.SlingRequestProcessor를 통해 요청을 처리할 수 없습니다. NPR-20706: CQ-94880용 핫픽스
...
* (Touch UI) 팀원을 프로젝트에 추가할 수 없습니다. NPR-20990: CQ-4205375용 핫픽스
...
* docConvertor가 요소에 대한 접두사 &quot;stEvt&quot;라는 오류와 함께 PDF/A를 생성하지 못합니다 `stEvt:action` 바인딩되지 않았습니다.&quot; NPR-21032: CQ-4222540용 핫픽스
* 서비스 OMPFSubmission/PDFA/PDFtoPDFA를 호출하는 동안 `java.lang.IllegalArgumentException message:No enum constant com.adobe.internal.pdfm.docbuilder.signature.PathValidationFailureReason.SIGNED_IN_FUTURE`라는 예외가 발생합니다. 이 예외는 서버를 다시 시작할 때까지 단기 서명 확인 프로세스를 완료할 수 없습니다. NPR-20792
...
* 테스트를 위해 onDialogLoaded에 유틸리티 함수를 추가했습니다.
...
* 국제화 사전은 서버가 org.apache.sling.i18n 2.5.6에서 다시 시작되는 경우 작동합니다. NPR-20525: Granite용 핫픽스 - 19490
* 기본 스레드 덤프 수집 프로그램 구성(기본 AEM 시작)을 사용하는 스케줄러 기간에 따라 스레드 덤프가 생성되지 않습니다. NPR-20288: GRANITE-19488/GRANITE-12741 CQ-90647용 핫픽스.

### Sites {#sites-9}

* 저장된 검색을 연 후 수정된 날짜 필터가 변경되는 경우 결과에 영향을 주지 않습니다. 그리고 표시되는 결과는 수정된 날짜 필터의 이전에 저장된 값과 동일합니다. NPR-19739: CQ-4219425용 핫픽스
...
* 동일한 페이지에서 제품을 만들 때 확인 또는 리디렉션 팝업 메시지가 표시되지 않습니다. NPR-20257: CQ-4223414용 핫픽스

### 사용자 인터페이스 {#user-interface-4}

* 날짜 선택기가 여러 필드 중 한 개인 필드인 경우 날짜 필드에 저장된 값은 구성 요소를 편집하는 동안 지속되지 않습니다. NPR-20077: GRANITE-19147용 핫픽스
...
* 모바일 양식을 PDF으로 보도록 구성한 경우 미리 채워진 양식이 작동하지 않습니다. NPR-20566
...
* 컨텍스트 허브용 독립 지속성 캐시에 대한 수정 사항.
* 자산 차원의 정확한 계산.
* Brand Portal에 자산을 게시할 때 AEM 성능이 최적화되었습니다.
* 캔버스 노드의 `Resourcetype` 값에 대한 수정 사항입니다.
* 문서 조각 콘텐츠에 대해 대/소문자 구분 및 특수 문자 검색 기능을 사용할 수 있습니다.
* Safari에서 PDF를 첨부 파일로 첨부할 수 있도록 적응형 양식이 개선되었습니다.
이 경험은 보다 빠르고 확장 가능한 복제를 위해 새로운 Dynamic Media 게시 인프라에 연결하는 새로운 Dynamic Media을 제공합니다.
...
* 사용자가 게시하려고 할 때 AEM에 예기치 않은 동작이 표시됩니다 `/unpublish/create` 다른 사용자가 잠근 페이지의 버전입니다. NPR-19249, CQ-4215298 및 CQ-4203856용 핫픽스
* 중첩된 시작을 수동으로 승격하는 동안 하위 페이지가 삭제됩니다. NPR-19704
* ContextHub 저장 시 지속성 문제가 초기화 중에 기본 지속성 레이어를 덮어씁니다. NPR-19979: CQ-4218399용 핫픽스
* 콘텐츠 조각이 다른 버튼과 겹칩니다. NPR-19980: CQ-4221519용 핫픽스
* SiteAdmin에서 별칭을 사용하여 보면 사이트 페이지가 표시되지 않습니다. NPR-20053: CQ-4221478용 핫픽스
* Adobe Campaign의 Importer 페이지를 가리키는 라이브 카피 페이지를 게시할 때 오류가 발생합니다. NPR-20066: CQ-4220846용 핫픽스

### 플랫폼 {#platform-8}

* PPT 슬라이드의 배경 이미지를 변환에 포함할 수 있도록 Apache POI를 버전 3.16으로 업그레이드했습니다. NPR-18286
* 동일한 폴더에 여러 자산을 업로드하는 동안 Internet Browser 11 및 Edge에서 렌더링 문제가 발생합니다. NPR-20062
...
* tagadmin/tagging 콘솔에서 AEM에서 Brand Portal으로 태그를 게시하도록 설정합니다. NPR-20271
...
* 적응형 양식의 필드에 validationState가 정의되지 않은 경우 elementFocusChanged 이벤트가 발생하면 오류 이벤트(errorState)가 Adobe Analytics 서버로 반환됩니다. NPR-19513

### Forms JEE 설치 관리자 {#forms-jee-installer-11}

#### 코어 {#core-3}

* 종료하는 동안에는 연결 관리자를 사용할 수 없습니다. JBoss®에서는 작성자 EAR을 배포하지 않은 이유로 손상 문제가 발생하기 전에 JDBC 종속성을 제거합니다. NPR-19703
...
* 번역 페이지에서 양식을 여러 개 전송하지 않도록 클릭 시 제출 단추를 비활성화했습니다.
* 대화 상자에 여러 RTE 구성 요소를 구성했습니다.
* Live Copy에서 ReferenceUpdates를 보완했습니다.
...
* 워크플로우 알림 서비스는 이메일의 링크를 인코딩하지 않으므로 사용자가 링크를 클릭한 후 로드할 수 없습니다. NPR-19490: CQ-4218055용 핫픽스
...
* AEM 문서 콘솔의 전체 크기 문서로 인해 축소판 렌더링이 느려집니다. NPR-19086: CQ-4217148
...
* 줄 바꿈이 없는 콘텐츠는 텍스트 편집기에서 콘텐츠를 줄 바꿈할 수 없습니다. NPR-19481
...
* Dynamic Media Cloud Service, Touch UI 및 보안 UI 인터페이스의 성능 문제 수정.
* Apache Felix Http Bridge 3.0.8 수정 사항
* 작성자 및 게시 환경 간 바이너리 없는 복제(BLR) 문제를 해결했습니다.
* Adobe Target과의 클라이언트측 통합을 위한 구현 라이브러리인 Target 라이브러리 파일 AT.JS에 대한 지원은 일반적인 웹 구현과 단일 페이지 애플리케이션 모두에 맞게 디자인되었습니다.
...
* TouchUI에서 자산을 게시할 권한이 없는 사용자를 위해 게시 버튼이 표시됩니다. NPR-18620, CQ-4214042용 핫픽스
* 사용권 계약이 설정되면 자산에 대한 다운로드 대화 상자에는 동적 렌디션 옵션이 표시되지 않습니다. NPR-18607, CQ-4212342용 핫픽스
* 이름에 공백이 있는 자산에 대한 동적 렌디션을 다운로드할 수 없습니다. NPR-18571, CQ-4211738용 핫픽스
* Creative Cloud와 자산 폴더를 공유할 때 두 명 이상의 사용자를 저장할 수 없습니다. NPR-18489, CQ-103297용 핫픽스
* dc: 제목과 dc: 설명이 crx/de의 복수 필드 값으로 변경되지 않습니다. NPR-18474, CQ-4209086용 핫픽스
* 자산 이동 작업으로 인해 성능이 저하됩니다. NPR-18346
...
* 사용자에게 복제 액세스 권한이 없는 경우에도 Publish 작업 버튼이 표시됩니다. NPR-17353, CQ-4209269용 핫픽스
* min:gcc;obfuscate=true를 사용하여 축소가 활성화된 경우 사이트 관리자 및 기타 관리자가 모두 작동하지 않습니다. NPR-18593, CQ-4209220용 핫픽스
* 매번 화면을 새로 고치지 않으면 사용자 정의 메뉴 항목이 표시되지 않습니다. NPR-18500, CQ-4213581용 핫픽스
* moment.js를 2.10.6으로 업그레이드. NPR-18596, Granite-11881용 핫픽스
* DM 매크로에 대한 권한을 적용하면 관리자의 보기가 중단됩니다. NPR-18544, CQ-4211729용 핫픽스
* 자산에 대한 나중에 게시를 수행하면 잘못된 ArgumentException이 발생합니다. CQ-4214532

### 사이트 {#sites-12}

* 시간이 컨텐츠에 설정된 정시에 도달하면 MongoDB가 있는 활성 상태의 작성자 클러스터에서 두 작성자가 동일한 컨텐츠에 대한 복제를 트리거하려고 합니다. NPR-18708, CQ-4210982용 핫픽스
...
* JCR 설치 프로그램은 패키지 설치 후 번들 버전을 업데이트하지 않습니다. NPR-18728, NPR-15135용 핫픽스
* BLR(Binaryless replication)이 작성 및 게시 환경 사이의 바이너리로 실패합니다. NPR-18704
* AEM 환경의 Apache Felix Http Bridge 해결 요청. NPR-18297
...
* tagadmin/tagging 콘솔에서 AEM에서 Brand Portal으로 태그를 게시하도록 설정합니다. CQ-4212165
...
>* 줄 바꿈이 없는 콘텐츠를 CM 텍스트 편집기에서 줄 바꿈할 수 없습니다. NPR-19449
>
...
* 태블릿의 레이아웃 모드에서 숨겨진 구성 요소를 효율적으로 관리합니다.
* 하이브리드 디바이스에 대한 빠른 작업을 도입했습니다.
* 라이브 카피 관련 구성 요소 수준 동기화 문제 해결.
...
* 승인 후 타임라인 콘솔에서 체크아웃 작업/워크플로우를 사용할 수 없습니다. 80개의 조각이 Assets 폴더에 추가됩니다. NPR-18257, CQ-4211214 및 NPR-18251용 핫픽스, CQ-4211216용 핫픽스.
...
* PDF에 대한 썸네일이 생성되지 않습니다. NPR-17831, NPR-17750, CQ-4210547용 핫픽스
* Adobe CQ DAM 만료 알림 작업은 만료된 자산을 비활성화하지 않습니다. NPR-17666, CQ-107766용 핫픽스
* 자산에 지정된 소유자가 없으면 자산 만료 활동이 중지됩니다. NPR-17665, CQ-4197946용 핫픽스
* 들어오는 참조가 150개 이상인 자산 폴더를 이동하면 null 포인터 예외가 발생합니다. CQ-4200981

### 사이트 {#sites-13}

* Personalization은 IP 범위에 대해 세그멘테이션 규칙이 설정된 경우 첫 번째 IP에만 작동합니다. NPR-18121, CQ-83767용 핫픽스
...
* 대상자가 큰(2000 이상) 페이지를 로드할 때 성능 문제가 발생합니다. NPR-17884, CQ-4209567용 핫픽스
* 페이지에서 다른 이미지를 제거한 후에는 이미지를 선택할 수 없습니다. NPR-17711, CQ-4201323용 핫픽스

### 플랫폼 {#platform-11}

* 필요한 권한이 있는 사용자에 대해 Touch UI 컨트롤이 숨겨집니다. NPR-17945, CQ-4211231용 핫픽스
...
* HTL 이미지 구성 요소가 렌더링될 때 URL의 파일 이름이 변경되어 URL이 손상됩니다. NPR-17908, CQ-4211587용 핫픽스
* 변경 후 페이지 속성을 종료할 수 없습니다. NPR-17832, CQ-96110용 핫픽스
...
* 편지 렌더링 중에 데이터 사전을 반복적으로 읽습니다. NPR-18482, CQ-4210805용 핫픽스
...
* 도구 모음 작업 및 Coral 구성 요소를 표시할 때 작업 표시줄의 응답성이 개선되었습니다.
...
* DAM 워크플로 단계의 Session 또는 ResourceResolver에서 얻은 이진 스트림은 마지막 블록에서 닫아야 합니다. 이렇게 해야 리소스 누수가 발생하지 않습니다. NPR-17385, CQ-4209452용 핫픽스
...
* 클래식 UI나 Touch UI를 사용하여 페이지를 이동하는 동안 이동 대화 상자에 150개를 넘는 참조가 표시되지 않아서 사용자가 이러한 참조를 업데이트하고 페이지를 다시 게시할 수 없습니다. 이 문제는 사이트 관리 노드에 구성할 수 있는 클래식 UI: &#39;maxRefNo&#39;의 속성을 도입하여 해결되었습니다. `'/libs/wcm/core/content/siteadmin'`. 이 속성은 대량 이동 작업 전에 표시되는 최대 참조 수(기본값 150)를 지정합니다. 페이지에 여러 참조가 있는 경우 movePage 대화 상자에 표시되지 않습니다. 이 구성은 노드에 구성을 적용하여 dam 관리자 및 기타 관리자에게도 작동합니다. `'/libs/wcm/core/content/damadmin'` 및 `'/libs/wcm/core/content/miscadmin'` 각각. NPR-17222, CQ-85878용 핫픽스
...
* 자산을 선택하고 개발자 도구를 클릭해도 작업 표시줄의 도구 모음 작업이 느린 연결로 항상 표시되지는 않으며 페이지를 다시 로드해야 합니다. NPR-17568, CQ-108365용 핫픽스
...
* 첨부 파일이 있는 적응형 양식의 경우 양식이 두 번째로 제출되면 afSubmissionInfo 태그에 대한 중복 항목이 제출된 XML에 생성됩니다. NPR-17364
...
* 가져오기를 위한 API 메서드 `com.adobe.icc.services.api.LetterInstanceService`가 작동하지 않습니다. NPR-17922, NPR-16008
* 편지를 편집하는 동안 텍스트 모듈에 추가된 변수가 데이터 바인딩 패널에 표시되지 않습니다. NPR-17940
* HTML 제출 작업에서 POST 방법을 사용하는 경우 서신 관리 UI가 시작되지 않습니다. NPR-17595

**Forms Manager**

* AB 테스트를 위해 구성된 적응형 양식을 사용하여 AB Testing 시작을 클릭해도 테스트가 시작되지 않고 브라우저 콘솔 오류가 발생합니다. NPR-17838
...
* AEM Forms 6.2 출력 서비스를 사용하여 특정 양식을 데이터 XML과 병합하는 데 20배 더 많은 시간이 소요됩니다. 이제 Windows 및 Linux® 환경에서 수정되었습니다. NPR-17501
...
* 편지 미리 보기 중에 텍스트 편집기에서 조각을 편집하는 동안 조각에 사용된 인라인 조건 대신 편집을 위해 처리된 텍스트를 표시해야 합니다. NPR-15748, NPR-17504
...
* Camera Raw 파일 렌디션, 타임라인 보기 및 이미지 방향에 대한 자산의 수정 사항
* 향상된 기능
...
* 에 열 추가 또는 사용자 지정 **Assets OmniSearch** 오버레이에 의한 결과 `/apps` 작동하지 않습니다. NPR-16737: CQ-4206785용 핫픽스
...
* Assets UI의 다른 PDF 내에 PDF을 생성해도 DAM UI에 생성된 PDF이 표시되지 않습니다. 하지만 PDF은 CRX 저장소에 표시됩니다. NPR-16833: CQ-4206501용 핫픽스
...
워크플로가 삭제되면 프로젝트 워크플로 콘솔에 페이지에 NullPointerException이 표시됩니다. NPR-17017: CQ-4194269용 핫픽스

### 사이트 {#sites-15}

* 작성자 인스턴스에서 `ContextHub`의 파일이 최소화되지 않습니다. NPR-17022: CQ-79456용 핫픽스
* WCM-Launch 실행 프로모션은 페이지의 대형 트리로 구성된 실행을 프로모션하는 데 오랜 시간이 소요됩니다. NPR-16480: CQ-82731용 핫픽스
* `ClientContext` 세그먼트 조건 렌더러는 작업 중이 아니거나 완료되지 않은 규칙을 사용하여 세그먼트(또는 대상자)를 만들 때 충돌합니다. NPR-16759: CQ-4205104용 핫픽스
* WCM 실행에서는 Touch UI의 페이지 속성 내에서 작업이 시작되면 실행과 연결된 페이지의 게시를 취소할 수 없습니다. NPR-16560: CQ-4204681용 핫픽스
...
* 다음으로 이동 **[!UICONTROL 전역 탐색]** firefox 또는 Google Chrome 브라우저를 사용하는 창은 다른 사용자 경험을 제공합니다. Firefox 브라우저에는 **[!UICONTROL 도구]** 메뉴 아래의 제품에서 사용할 수 있습니다. Google Chrome 브라우저에는 **[!UICONTROL 탐색]** 메뉴 아래의 제품에서 사용할 수 있습니다. NPR-16770, CQ-4200456용 핫픽스

### 캠페인 {#campaign}

* AEM 캠페인 템플릿을 테스트하고 시드 주소를 수정하여 &#39;추가 데이터&#39;를 포함하는 동안 Adobe Campaign 드롭다운이 Touch UI 컨텍스트 허브에서 사라집니다. NPR-16771: CQ-105748용 핫픽스

### 모바일 온디맨드 {#mobile-on-demand-3}

* AEM Author에서 발행물을 사전 점검할 때 5초 이상 걸리는 사전 점검 작업이 있으면 AEMM - AEM PECS 통합 Splunk 대시보드에 높은 상태 요청이 있는 비정상적인 스파이크가 발생합니다. NPR-16908: CQ-4207055용 핫픽스
...
* 번역 기능을 사용하여 만든 언어 사본이 로컬 국가 Live Copy 대신 루트 기본을 가리킵니다. NPR-17257, CQ-4208287용 핫픽스
...
* 적응형 Forms 편집기에서 head.jsp의 Target 설정 주석을 새 context hub 문으로 바꿔야 합니다. NPR-17173
* 적응형 Forms 규칙 편집기에서 **[!UICONTROL 항목 선택]** 이벤트를 &#39;null&#39;로 표시합니다. NPR-17139
* 제출된 양식은 앞으로 화살표(>)를 사용하여 앞으로 이동하여 다시 제출됩니다. NPR-17080
...
* 유형의 정규 표현식 지원 `dataRef=C:/Users/`다음에서 **[!UICONTROL 기본 미리 채우기 서비스 구성]**. 이 유형은 적응형 Forms을 위한 데이터 미리 채우기용입니다. NPR-16425
...
* 구문 **[!UICONTROL 양식 저장]** 규칙 편집기에서 작동하지 않습니다. NPR-16905
...
* 출력 서비스에서 &quot;milli-sec&quot; 필드를 추가하도록 수정된 PDF을 처리하지 못합니다. `date-time format` 메타데이터. NPR-16838
...
* 중첩된 파일(JSP 또는 JavaScript 파일) 간의 충돌을 감지하는 패키지 관리자의 유효성 검사 옵션 `/apps` 아래에 핫픽스에 포함된 `/libs`. 그런 다음 영향을 받는 오버레이를 다시 기반으로 하여 아래 파일의 변경 사항을 포함할 수 있습니다. `/libs`. NPR-16216: CQ-81729용 핫픽스
...
* AEM 6.0에서 AEM 6.2로 업그레이드한 후 많은 쿼리로 인해 태그를 검색하는 동안 클래식 UI의 성능이 저하됩니다. 이 문제를 해결하려면 아래 단계를 참조하십시오. [태깅 콘솔에서 복제 상태 비활성화(클래식 UI)](#disable-replication-status-in-tagging-console-classic-ui-npr) 팔로우할 수 있습니다. NPR-15842: CQ-4201748용 핫픽스.
...
* Touch UI 사이트 화면에서 하위 페이지가 없는 페이지에 페이지를 붙여넣으려고 하면 붙여넣기 단추를 사용할 수 없으므로 작동하지 않습니다. NPR-15894: CQ-4201696용 핫픽스.
...
* `wcm/foundation/components/parsys` 구성 요소는 **[!UICONTROL &#39;구성 요소를 여기로 끌어오십시오]**&#39; 자리 표시자가 표시되지 않습니다. NPR: 16748: CQ-4205187용 핫픽스
...
* 제목에 특수 문자가 포함된 컨텐츠 계층 구조에 폴더가 만들어지면 해당 문자의 인코딩된 버전이 표시됩니다. NPR-15935: CQ-4202987용 핫픽스
* &#39;만들기&#39; 버튼을 사용할 때 표시되는 일관되지 않은 동작으로 인해 에셋을 탐색하는 동안 에셋을 업로드하거나 폴더를 만들 수 없습니다. NPR-16410: CQ-4204793용 핫픽스
* AEM 작성의 문서 보기에서 공유 HTML 리소스를 업로드하는 동안 예기치 않은 오류가 발생합니다. NPR-16133: AEMM-4155970용 핫픽스
...
* 타깃팅을 사용할 때 캠페인을 게시해도 브랜드 및 기본 파트를 포함한 전체 트리가 자동으로 게시되지 않습니다. NPR-15855: CQ-94630용 핫픽스

### 번역 {#translation-8}

* 이제 번역 작업 동기화가 자동으로 트리거되고 번역 프로젝트를 시작하지 않고도 AEM 폴링을 수행할 수 있습니다. NPR-15163: CQ-90856용 핫픽스
...
* 첨부 파일과 함께 적응형 양식을 저장하는 동안 첨부 파일의 전체 경로가 `fileAttachment` 태그는 첨부 파일의 이름 대신 생성된 XML의 태그로 지정됩니다. NPR-16529
...
* 양식 편집기의 조각 내에 조각을 저장하려고 할 때 조각 모델 루트가 하위 조각의 값을 채우지 않습니다. NPR-15943
...
* 여러 첨부 파일을 허용하는 파일 첨부 위젯의 경우 이미 이전 첨부 파일이 있는 위젯에서 첨부 파일이 있는 새 양식 인스턴스를 제출하면 오류 코드가 표시됩니다. 이 오류는 실제 콘텐츠 대신 추가된 첨부 파일을 열 때 발생합니다. NPR-16258
* `file://`, `http://` 및 `ftp://` 등의 프로토콜을 통해 권한 없는 액세스로부터 양식 미리 채우기 서비스를 보호합니다. 다음을 참조하십시오 [구성 관리자를 사용하여 미리 채우기 서비스 구성](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions). NPR-15414

* 확인 단계에서 HTML 대신 PDF 형식으로 적응형 양식을 렌더링하도록 요청하고 모든 첨부 파일을 PDF에 추가하므로 인쇄물에 전체 양식이 표시됩니다. NPR-9011

**서신 관리**

* 미리보기 또는 편집 모드에서 편지에서 텍스트 조각을 사용하여 작업하는 동안 텍스트를 목록으로 변환하면 전체 편지 기능이 중단됩니다. 그리고 JavaScript 오류가 생성됩니다. NPR-16460
...
* Internet Explorer 브라우저를 사용하여 스크롤 가능한 내용이 있는 문자를 미리 보는 동안 브라우저의 스크롤 막대가 문자의 스크롤 막대와 겹칩니다. 이 때문에 오른쪽에 있는 조각의 경우 전체 내용을 볼 수 없습니다. NPR-16068
...
* file://, &quot;http://&quot; 및 ftp:// 등의 프로토콜을 통해 권한 없는 액세스로부터 양식 미리 채우기 서비스를 보호합니다. 자세한 내용은 [구성 관리자를 사용하여 미리 채우기 서비스 구성](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions). NPR-15434
...
누적 수정 팩 2의 주요 사항은 다음과 같습니다.

* Sling 프레임워크 및 작업을 포함하여 AEM 플랫폼의 안정성 수정 및 성능 개선 사항
...
* 인터페이스가 또 다른 인터페이스를 확장하면 슈퍼 인터페이스에서 주입 가능한 메서드가 올바르게 주입되지 않습니다. NPR-15202: SLING- 5710용 핫픽스
...
* 사용자가 CRXDE에서 노드를 선택합니다(예: `/content/dam/`). 그런 다음 &#39;액세스 제어&#39; 탭을 클릭하여 액세스 제어 목록이 있는지 확인합니다. 이제 일부 요소를 드래그하여 놓으면 선택한 요소가 아니라 요소가 이동됩니다. NPR-15696, GRANITE-16300용 핫픽스
* 가장을 시도할 때 드롭다운 목록에서 사용자를 선택하면 전체 사용자 팝업이 사라집니다. NPR-15774: CQ-4201738/GRANITE-11895용 핫픽스
* Omnisearch에서는 자동 작성된 제안을 포함하는 태그로 검색할 수 없습니다. NPR-15088: GRANITE-22231용 핫픽스.
...
* 사용자가 워크플로우를 활성화한 후 페이지를 수정하는 경우, WCM 코어의 워크플로우 받은 편지함에 대한 수정 상태가 변경되지 않습니다. NPR-15684: CQ-4196974용 핫픽스
...
* 콘텐츠 조각 편집기 UI에서 콘텐츠 조각의 변형을 만들 때 사이드 패널에는 모든 변형을 탐색하는 스크롤바가 표시되지 않습니다. NPR-15445: CQ-4199444용 핫픽스
...
* 클래식 UI의 슬라이드쇼 구성 요소는 슬라이드를 만들거나 이미지를 끌어다 놓는 방식으로 슬라이드를 만들 수 없습니다. NPR-15281: CQ-4194164용 핫픽스
...
* Sites 구성 요소의 페이지 속성 썸네일 탭에 지우기 단추가 없습니다. NPR-15143, CQ-4196997용 핫픽스
...
* 타임워프 모드 중에 편집 페이지를 닫고 사이트 관리자로부터 다시 열려고 하면 상태에 오류가 발생합니다 `500`. NPR-14965: CQ-109647용 핫픽스:
* DAM(Digital Asset Manager) UI에서 사용자 선택기의 승인 가능 대상 찾기 검색을 수행하면 &#39;메모리 부족&#39; 예외가 발생합니다. NPR: 15307: CQ-98542용 핫픽스

### 자산 {#assets-17}

* Omnisearch에서 에셋을 검색한 후, 에셋을 선택하고 을 클릭하여 속성을 편집하십시오. **속성 보기**, 그런 다음 **저장** 버튼은 사용자를 빈 페이지로 리디렉션합니다. NPR-15900: CQ-4202372용 핫픽스
* Assets 사용자 인터페이스가 이벤트에 응답하지 않습니다. 자산을 선택하고 &#39;게시&#39; 또는 &#39;렌디션&#39;을 클릭해도 어떤 작업도 수행되지 않습니다. NPR-15828: CQ-4202247용 핫픽스
* 카드 보기에서 자산을 게시할 때 게시된 상태를 반영하도록 카드가 업데이트되지 않습니다. 대신 페이지가 새로 고쳐집니다. NPR-15826: CQ-102732용 핫픽스
* Assets 핫픽스를 포함하는 누적 핫픽스. NPR-15225
* 앰퍼샌드(&#39;&amp;&#39;) 문자가 에셋 폴더 이름에 포함된 경우, 에셋으로 이동할 때 폴더 이름이 올바르게 표시되지 않습니다. NPR-15775: CQ-4201735용 핫픽스
* 자산 파일 이름에 앰퍼샌드(&#39;&amp;&#39;) 문자를 사용하면 해당 속성에 액세스할 때 문제가 발생합니다. NPR-15770: CQ-4201737용 핫픽스
* Assets을 탐색하고 &#39;열 보기&#39; 표시 모드를 사용하는 동안 사용자가 에셋을 선택하고 클릭한 후 페이지를 새로 고치면, 새로 고친 콘텐츠 대신 에셋 세부 사항이 표시됩니다. NPR-15768: CQ-4201727용 핫픽스
...
* Digital Asset Manager를 사용하는 동안, 페이지가 이미지 세트와 연결된 경우 이미지를 새 폴더로 이동하면 페이지 연결이 끊어집니다. 따라서 연결된 페이지에 일부 이미지가 누락됩니다. NPR-15538: CQ-111479용 핫픽스
...
* 위치 **[!UICONTROL Touch UI]**, Internet Chrome 브라우저 버전 56.0.2924.87을 사용하는 동안 이제 type=&#39;datetime&#39;인 날짜 필드에 저장된 날짜가 표시됩니다. NPR-15383: GRANITE-16481용 핫픽스
...
* Omnisearch는 고객이 `/apps` 위치 구성이 아래에 나열되어 있다고 가정하므로 열 데이터 소스를 추가하려면 */libs/granite/omnisearch/content/metadata/*. NPR-13188: GRANITE-16479용 핫픽스
* **[!UICONTROL Touch UI]**&#x200B;를 사용할 때 제품 변형이 제품과 동일한 수준에서 만들어지지 않습니다. 변형 작성 프로세스의 상태에 대해 사용자에게 알려 주지 않습니다. NPR-15345: CQ-4198948용 핫픽스

**Scene7**

* Scene7 워크플로우를 실행하면 열려 있는 파일이 닫히지 않습니다. 공유 풀링 구성으로 단일 HttpClient 인스턴스를 유지 관리하고 재사용할 수 있도록 AEM-S7 서비스를 개선하도록 요청합니다. NPR-15357: CQ-109958용 핫픽스

### 번역 {#translation-9}

* 번역 프로젝트를 사용할 때, 영어 기본에서 언어 사본을 업데이트하면 이름과 소스 루트가 동일한 11개의 개별 시작이 생성됩니다. 그러나 페이지 이름이 설정된 패턴을 따르는 경우 시작 루트가 각기 약간 다릅니다. NPR-15605: CQ-4200699용 핫픽스
* 언어 루트에서 이름에 하이픈 및 대시가 있는 경우 페이지에 대한 번역 프로젝트가 생성되지 않습니다. NPR-15171: CQ-96286용 핫픽스
* Microsoft® Translator API를 사용할 수 있도록 Microsoft® 커넥터를 업데이트하는 요청입니다. 이 API는 Microsoft®에서 Azure 포털에서 사용할 수 있도록 지원합니다. NPR-15320: CQ-101010용 핫픽스
...
* CSRF 토큰 매개변수가 GET 메서드를 사용하여 양식에 추가되었습니다. NPR-15229
...
* 다음 `afData/afBoundData` 사전 작성된 XML에 이 없더라도 래퍼가 제출된 XML에 있습니다. `afData/afBoundData` xml 스키마 기반 적응형 양식의 래퍼. NPR-15541
...
* CCR UI에서 여러 개의 헤더 나누기가 포함된 텍스트의 자산 관리에서 탭 정렬 집합입니다. NPR-15818
* Google Chrome에서 Tab 키를 사용하여 만든 맞춤 콘텐츠가 텍스트에 포함되어 있지만 텍스트 모듈의 썸네일은 정렬된 콘텐츠를 표시하지 않습니다. NPR-15819

`**Forms Portal**`

* XDP Forms에 대해 미리 채우기 서비스가 작동하지 않습니다. NPR-15466
* 적응형 양식 초안 및 데이터베이스에 제출 문서를 저장할 때 데이터베이스 연결이 실패하면(예: 오랫동안 사용하지 않은 경우) 적응형 양식의 상태가 손상됩니다. NPR-15297
...
* 출력 서비스를 사용하여 특정 양식을 데이터 xml과 병합하는 동안 응답 시간은 ES4 SP1 서버에서 걸리는 시간과 비교하여 20배입니다. NPR-15283
...
* VersionManagerImpl이 버전 기록에서 잘못된 버전을 삭제하는 문제 NPR-14372
...
* 링크와 같은 리치 텍스트 필드를 여러 개 만들 때 Target 드롭다운 목록이 Touch UI 대화 상자에서 작동하지 않습니다. NPR-13911
* 대화 상자(Touch UI)에서 여러 RTE(Rich Text Editor) 속성이 있는 텍스트 필드를 편집할 때 포커스가 임의로 특정 RTE 속성으로 이동합니다. NPR-13703
* 기본 기본 비디오 구성 요소는 비디오 썸네일을 렌더링하지 않습니다. NPR-14976
...
* 편집기에서 PageProperties 대화 상자를 제출하면 MSM Post 프로세서가 `msm:writeLiveCopyConfig` 매개 변수. NPR-14434
* 롤아웃 구성 요소, 라이브 카피 및 MSM의 기타 측면과 관련된 여러 문제입니다. NPR-12235

### 자산 {#assets-18}

* 압축 풀기 워크플로에서 이미지 파일 이름에 특수 문자가 있는 이미지를 처리할 수 없습니다. NPR-15227: CQ-103887용 핫픽스
* 조건 표현식이 있는 반복이 포함된 자산이 제대로 표시되지 않습니다. 사용자가 `*CDN3835RLCEN*` 편지 템플릿을 미리 볼 때 본문 대상 영역에 있는 자산이 표시되지 않습니다. 여러 첨부 파일을 허용하는 파일 첨부 위젯의 경우 이미 이전 첨부 파일이 있는 위젯에서 첨부 파일이 있는 새 양식 인스턴스를 제출하면 오류 코드가 표시됩니다. NPR-14844
...
* 이제 복제 권한이 있는 사용자가 자산 폴더를 삭제할 수 있습니다. NPR-14321: CQ-88271용 핫픽스
...
* AEM Assets에서 읽기 액세스 권한이 없는 사용자에 대해 중복 자산을 탐지할 수 있도록 요청. NPR-13851: CQ-102281용 핫픽스
...
* 사용자가 `Configure Columns` 대화 상자에서 모든 선택 사항을 선택하면 자산 보고서 페이지가 응답하지 않습니다. NPR-13187: CQ-95589용 핫픽스
...
* AMS AEM Assets 작성자 인스턴스의 개별 네트워크에서 액세스, 폴더에 대한 삭제 권한 없이 청크 업로드를 사용하여 에셋을 업로드할 수 없음. NPR-12768: CQ-82715용 핫픽스
...
* AEM 기본 워크플로를 사용하는 경우 CQ 발송은 단일 멤버의 이메일 주소를 누락한 그룹에 이메일 알림을 보내지 못합니다. NPR-14804: CQ-91499용 핫픽스 요청
* Touch UI의 받은 편지함 및 알림 배지에 대한 성능이 개선되었습니다. NPR-14145: CQ-101125용 핫픽스
* 워크플로우를 시작하는 동안 워크플로우 받은 편지함 콘솔에서 페이로드를 미리 볼 수 없습니다. NPR-13226: CQ-100275용 핫픽스
* SAML 인증 핸들러를 사용하여 구성된 &#39;saml_request_path&#39; 쿠키는 추가 항목으로 설정된 쿠키를 표시합니다 `?` 문자. 또한 SAML 응답이 AEM에 다시 게시되면 AEM &#39;saml_request_path&#39; 쿠키에서 이미 인코딩된 문자로 인해 잘못된 값을 반환합니다. NPR-13517: GRANITE-11722 및 GRANITE-14414에 대한 사전 예방 핫픽스

### Dynamic Media {#dynamic-media}

* 복제 중 AEM 활성화가 아카이브 작업으로 기록될 때 생성 및 취소된 수많은 `AEM-Scene7` 작업. NPR-12835: CQ-86115용 핫픽스
...
* 저장 또는 제출 중에 라디오 단추의 기본값을 설정하고 다른 값을 선택하면 미리 채우기에 선택한 값이 표시되지 않습니다. NPR-15304
* Google Chrome은 드롭다운 목록을 동적으로 채우고 선택한 항목의 값을 제출하기 위한 옵션 이벤트 사용 시 잘못된 동작을 보여 줍니다. NPR-15198
...
* 탐색하는 동안 *양식 및 문서* 디렉터리에서 사용자가 에셋을 복사한 후 다른 폴더로 이동하면 붙여넣기 단추가 표시되지 않습니다. CQ-111327
...
* HTML Workspace의 전달된 초안 작업이 초기 사용자에게 반환되면 초기 사용자의 큐에 작업이 표시되지 않습니다. NPR-15178
...
* 사용자가 선택한 양식 로케일을 프랑스어(캐나다)로 사용하여 맞춤법 검사 유틸리티를 실행할 때 Forms Designer이 충돌합니다. NPR-13740
...
>[!NOTE]
>
>Adobe에서 제공하는 선택적 기능 팩은 릴리스 버전 및 누적 수정 팩에 종속되어 있습니다. 기능 팩이 설치되어 있는 경우 [AEM 고객 지원팀](https://experienceleague.adobe.com/?support-solution=General#support)에 문의하여 이 AEM 6.2용 누적 수정 팩과의 호환성을 확인하십시오.
...
* AEM 6.2 서비스 팩 1은 CFP를 위한 필수 구성 요소입니다. 설치 지침은 [AEM 6.2 서비스 팩 1](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)의 릴리스 정보를 참조하십시오.
...
1. 패키지를 다운로드하려면 [소프트웨어 배포](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq640/cumulativefixpack/aem-6.4.8-cfp-2.0.zip)를 클릭합니다.
...
1. 모든 OSGI 번들은 OSGi 콘솔에서 ACTIVE 이거나 FRAGMENT 입니다(웹 콘솔 사용: /system/console/bundles).
...
## DTM, Analytics, Target 연결에 대한 사용자 구성 가능한 시간 초과 매개변수 {#user-configurable-timeout-parameters-for-dtm-analytics-target-search-promote-connections}

AEM 누적 수정 팩 6.2 SP1-CFP7 이상 릴리스를 사용하면 아래 세부 사항에 따라 위의 모든 연결에 대해 연결 시간 초과 기간을 구성할 수 있습니다.

| **연결** | **연결 시간 제한&#42;** | **소켓 시간 제한&#42;&#42;** |
|---|---|---|
...
* 오버레이 *&quot;/libs/cq/tagging/widgets/source/widgets/admin/TagAdmin.js&quot;* 위치: *`/apps`*
...
>[!NOTE]
>
>이러한 구성 설정은 Document Security를 사용하는 AEM Forms 고객에게만 해당됩니다.
...
1. 의 백업 만들기 `jsafeFIPS.jar`, `jsafeJCEFIPS.jar`, 및 `certjFIPS.jar` 파일 위치: [AEM_Forms_Installation_directory]`/jboss/modules/system/layers/base/com/adobe/livecycle/main/` 이전에 언급된 디렉토리에서 파일을 삭제합니다.

새 JAR 파일을 가져오기 위해 [Adobe 지원](https://experienceleague.adobe.com/?support-solution=General#support)에 문의하십시오. [Adobe 지원](https://experienceleague.adobe.com/?support-solution=General#support)([AEM_Forms_Installation_directory]/jboss/modules/system/layers/base/com/adobe/livecycle/main/)에서 가져온 JAR 파일을 배치합니다.
...
사용자가 작업을 요청할 때 다른 사용자에 대한 공유 큐 개수를 새로 고치지 않습니다. 따라서 Adobe은 새 속성을 도입했습니다. 아래 절차에 따라 AEM 인스턴스에서 이 속성을 구성하십시오.

1. 관리자 UI -> 서비스 -> 작업 공간 -> 전역 관리로 이동합니다.
1. 전역 설정을 내보냅니다.
1. 다운로드한 XML 파일에 태그를 추가합니다 `<client_tasksPollingInterval>10</client_tasksPollingInterval>`. 10은 예제 값(초)입니다. 그에 따라 수정할 수 있습니다.
1. 파일을 저장합니다.
...
* `dc:title` 속성이 문자열 [](multifield)로 설정된 이미지의 이미지 카드에 제목을 표시할 때의 동작 변경: 모든 제목이 CRX에 저장되지만 UI의 이미지 카드에 변경된 최신 제목만 표시됩니다. CQ-4217165용 핫픽스
...
* 다음과 같은 오류 **구성 요소 인스턴스 만들기** 및 **서비스 팩토리에서 null을 반환했습니다.** 저장소 다시 시작으로 인해 발생합니다.
...
* Mongo 및 DB2®의 CFP 설치 시 발견된 오류: **org.apache.sling.discovery.oak.TopologyWebConsolePlugin addDiscoveryLiteHistoryEntry: Exception: java.lang.NullPointerException**. CFP8을 통해 CFP를 설치한 후에는 이 오류가 발생하지 않습니다.
* (Adobe Granite Maintenance Scheduler 업데이트 작업) com.adobe.granite.maintenance.impl.TaskScheduler: window `granite:weekly`를 위한 WorkflowPurgeTask에 유지관리 작업이 없음
...
* 스마트 태그 기능 팩이 포함된 AEM 6.2 SP1에 CFPx를 설치하면 DAM 자산 업데이트 워크플로우에서 스마트 태그 Assets에 대해 이전에 추가한 워크플로우 단계가 삭제됩니다.
...
## OSGi 번들 및 콘텐츠 패키지 포함됨 {#osgi-bundles-and-content-packages-included-5}
