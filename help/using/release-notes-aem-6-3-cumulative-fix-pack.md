...
AEM 누적 수정 팩 6.3.3.8은 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
AEM 누적 수정 팩 6.3.3.7는 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
* 리치 텍스트 편집기(RTE). 임베드된 테이블을 목록 항목으로 삽입할 수 없습니다(NPR-30878).
...
AEM 누적 수정 팩 6.3.3.6는 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
AEM 누적 수정 팩 6.3.3.5는 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
AEM 누적 수정 팩 6.3.3.4는 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
AEM 누적 수정 팩 6.3.3.3는 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
AEM 누적 수정 팩 6.3.3.2은 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 AEM 6.3 서비스 팩 3 릴리스 정보를 참조하십시오.
...
* cq: 작업은 타겟팅된 구성 요소에 대해 고려되지 않습니다. NPR-27616: CQ-4257497용 핫픽스
...
AEM 누적 수정 팩 6.3.3.1은 AEM 6.3 서비스 팩 3에 종속됩니다. 따라서 AEM 6.3 서비스 팩 3을 설치한 후 AEM 누적 수정 팩 6.3.3.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 3 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
* 페이지 버전이 생성되고 비교가 트리거되면 /content/ versionhistory의 노드가 Blueprint의 라이브 카피 목록에 나열됩니다. NPR-26506: CQ-4243957용 핫픽스
...
AEM 누적 수정 팩 6.3.2.2는 AEM 6.3 서비스 팩 2에 종속됩니다. 따라서 AEM 6.3 서비스 팩 2를 설치한 후 AEM 누적 수정 팩 6.3.2.x 패키지를 설치해야 합니다. 설치 지침은 [AEM 6.3 서비스 팩 2 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp2-release-notes.html)를 참조하십시오.
...
* 사용자 정의 at.js 또는 mbox.js를 제공할 때 포함 스크립트가 HTML 태그 대신 텍스트로 페이지에 작성됩니다. NPR-22441: CQ-4203691용 핫픽스
...
* 규칙 편집기의 사용자 정의 함수에서 함수 호출 후 ;을 추가하면서 사용자 정의 함수가 true를 반환해도 유효성 검사가 실패합니다. NPR-22481: CQ-4235499용 핫픽스
...
* 일부 사용자 정의 배포의 경우 addTask 모듈에서 담당자를 선택하려는 사용자가 userpicker의 목록을 채우는 데 시간이 오래 걸립니다. NPR-20283: CQ-4224193용 핫픽스

### 사용자 인터페이스 {#user-interface-3}

* 대화 상자의 속성에도 불구하고 Colorfield가 “항상 필요”로 설정됩니다. NPR-19702
...
* 워크플로 모델의 대화 상자 참가자 단계에서 드롭다운을 클릭했을 때 OOTB granite 사용자 선택에 사용자가 로드되지 않습니다. NPR-20236
...
* dc: 제목과 dc: 설명이 crx/de의 복수 필드 값으로 변경되지 않습니다. NPR-19570: CQ-4209086용 HF
...
* 양식이 최대화/최소화되어 초안으로 저장되거나 전달된 경우 작업 공간에서 워크플로 첨부 파일, 노트 및 세부 사항 탭이 작동하지 않습니다. NPR-20243
...
* 서신 관리, 문서 보안 및 Forms 워크플로에 대한 유용성 수정 사항입니다.
...
* AEM 6.3.3.0은 CFP을 위한 필수 구성 요소입니다. AEM 설치를 AEM 6.3으로 업그레이드하는 방법에 대한 세부 지침은 [업그레이드 설명서](https://docs.adobe.com/docs/en/aem/6-3/deploy/upgrade.html)를 참조하십시오.
...
>[!NOTE]
>
>6.3.3.0 이상 릴리스를 설치하는 경우 아래 절차를 수행하여 JBoss 애플리케이션 서버에 대한 설정을 구성합니다. Oracle WebLogic 또는 IBM WebSpehere 애플리케이션 서버에서 실행 중인 AEM Forms 서버에 6.3.3.0을 설치하는 경우 추가 구성이 필요하지 않습니다. 자세한 내용은 [AEM 6.3.3.0 릴리스 정보](https://helpx.adobe.com/kr/experience-manager/6-3/release-notes/sp3-release-notes.html)를 참조하십시오.
...
>[!NOTE]
>
>이러한 두 가지 문제의 영향을 받는 경우 [AEM 고객 지원 센터](https://helpx.adobe.com/kr/marketing-cloud/contact-support.html)에 문의하십시오.
...
기본값은 1입니다. 값은 CQ.PAGE_PROPERTIES_MAX_RECURSION_LEVEL 속성의 댓글을 해제하고 필요한 값(페이지 속성 데이터가 저장될 때까지 페이지의 / jcr:content 아래의 최대 깊이)을 할당하여 constants.js(`/libs/cq/ui/widgets/source/constants.js`) 파일을 오버레이해서 재정의할 수 있습니다.
