...
* 구성 요소의 콘텐츠가 작성자 인스턴스에서 변경된 다음 활성화되면 구성 요소가 다시 시작될 때까지 Publish 인스턴스에 표시되지 않습니다. **com.day.cq.personalization.impl.TargetedContentManagerImpl**(NPR-32489 및 NPR-32232).
...
* 30693 컨텐츠 전용 드롭다운에서 필터 옵션을 선택한 다음 이동 옵션을 선택하기 전에 Assets이 선택되었습니다(Touch UI의 열 보기에서).
...
* 사용자가 왼쪽 레일 필드에 초점을 맞추고 키보드 단축키를 사용하여 콘텐츠를 붙여넣습니다. 이렇게 하면 왼쪽 레일 필드에서 복사한 콘텐츠 대신 페이지 편집기 클립보드의 콘텐츠를 붙여넣습니다(NPR-31173).
...
* Analytics 보고서는 AEM 작성자 환경에서 채워지지 않습니다. 대신 빈 페이지가 표시됩니다(NPR-30905).
...
* Dynamic Video에 의한 비디오 집계는 결과 세트에 있는 상위 100개 항목만 반환합니다. NPR-30441: CQ-4213561용 핫픽스
* Data power를 통한 Adobe 스마트 태그 연결 문제. NPR-30026: CQ-4269457용 핫픽스
* 이름에 백분율 기호(%)가 있는 폴더로 아카이브 압축을 푼 경우 Assets 인터페이스를 사용하여 열 수 없습니다. NPR-29989: CQ-4270467용 핫픽스
...
* CSV 내보내기를 생성하는 동안 목록 보기에 대한 사용자 지정 열을 추가하면 보고서가 중단됩니다. NPR-30208: CQ-4273344용 핫픽스
* /etc/reports/의 OOTB 보고서가 제대로 작동하지 않고 내역 데이터 그래프가 표시되지 않습니다. NPR-30016: CQ-4220180용 핫픽스
* resourceType 요청 매개 변수의 값이 큰따옴표로 묶인 HTML 태그 특성의 값에 복사됩니다. NPR-29832: CQ-4255365용 핫픽스

### 커뮤니티 {#communities-1}

* AEM Communities 중재 콘솔에서 컨텐츠 문제가 중복되었습니다. NPR-30667: CQ-4276829용 핫픽스
...
* HTML-PDF 서비스에서 로드 테스트를 수행하면 오류가 발생하여 로드 테스트가 실패하고 파일 유형 설정이 AEM Forms 서버에서 제거됩니다. NPR-30111, NPR-30086: CQ-4271495용 핫픽스
...
* 자산 세부 사항 페이지에서 비디오 자산에 대한 이미지 렌디션을 삭제할 수 없습니다. NPR-29417: CQ-4268675용 핫픽스
* 소유자가 개인 폴더 내에 개인 폴더를 만들 수 없습니다. NPR-29397: CQ-4229830용 핫픽스
* 2GB를 초과하는 Adobe Illustrator Artwork 파일을 업로드하면 Java™ 힙 공간 오류가 발생합니다. NPR-29265: CQ-4226217용 핫픽스
...
* CoralUI가 Multifield와 함께 사용되는 경우 multifield 수준이 아닌 구성 요소 수준에서 fileReferenceParameter를 저장합니다. NPR-29535: CQ-4266129용 핫픽스
* AEM 6.3.3.3에서 최신 및 현재 페이지 버전 비교를 시도하는 중 문제가 발생했습니다. NPR-29532: CQ-4269639용 핫픽스
* 경로 필드는 검색하도록 지정된 경로와 관계없이 루트 경로에서 열립니다. NPR-29398: CQ-4268897용 핫픽스
* (경험 조각) FacebookApplication#setUpApp은 이제 사용되지 않는 API를 사용하므로, 더는 작동하지 않습니다. NPR-29213: CQ-4266630용 핫픽스
* 인스턴스에서 축소가 활성화된 경우 구성 요소를 WCM 페이지에 추가할 때 오류 경고가 생성됩니다. NPR-29476: CQ-4266197용 핫픽스
* 롤아웃 중에 블루프린트에서 빈 속성과 여러 속성이 전파되지 않습니다. 블루프린트로 재설정된 Live Copy가 구성 요소에 대해 작동하지 않습니다. NPR-29252: CQ-4264928, CQ-4264926, CQ-4267722용 핫픽스
...
* 스마트 이미지를 사용하는 경우 경험 조각을 target으로 내보낼 수 없습니다. CQ-4269606용 핫픽스
...
* 워크플로우 CommandLineProcess가 작은 따옴표가 있는 파일 이름으로 실패합니다. NPR-28805: CQ-4262287용 핫픽스
* 필터를 사용할 때 컬렉션 페이지와 컬렉션 페이지 간에 값이 다릅니다. NPR-28642: CQ-4261405용 핫픽스
...
* 에셋 세부 정보 페이지에서 비디오 에셋의 이미지 렌디션을 삭제할 수 없습니다. NPR-29149: CQ-4266073용 핫픽스
...
* `coral.js` 파일에 `handlebars.js` 라이브러리의 취약한 버전이 포함되어 있습니다. NPR-26973: CQ-4255377용 핫픽스
* 중첩된 레이아웃 컨테이너 및 텍스트 구성 요소와 함께 Target 구성 요소를 사용하면 텍스트를 편집하거나 컨테이너를 클릭할 때 JavaScript 오류 &#39;null currentPos 속성을 읽을 수 없습니다&#39;가 발생합니다. NPR-29077: CQ-4246594용 핫픽스
* (Touch UI) 이미 다른 태그로 태그가 지정된 페이지로 태그를 대량 업데이트할 수 없습니다. NPR-28729: CQ-4262922용 핫픽스
* 카드 보기에서 변형을 열면 500 오류가 발생합니다. NPR-28611: CQ-4263571용 핫픽스
* 기본 리드에서 이동된 구조를 롤아웃하면 잘못된 `cq:moveTarget`이(가) 발생합니다. NPR-28968: CQ-4265280용 핫픽스
...
* 태그를 클릭하면 글로벌 마우스 업 이벤트가 제거되고 대화 상자가 드래그 가능한 모드로 고정됩니다. NPR-28641: CUI-7294용 핫픽스
...
* 정책 집합 보기 페이지에서 페이지당 항목을 선택하는 옵션을 활성화했습니다.
...
* 공유 대기열 응답 작업은 HTML5 작업 영역에서 Flash 요소를 엽니다. NPR-29161: CQ-4266498용 핫픽스
* 단추에 모음 기호 문자가 포함된 경우 Workspace에서 제출할 수 없습니다. NPR-29014: CQ-4263172용 핫픽스

#### Forms - 문서 보안 {#forms-document-security}

* 정책 집합 보기 페이지에서 페이지당 항목을 선택하는 옵션을 활성화합니다. NPR-29243: CQ-4268567 및 CQ-4265132용 핫픽스
...
* Designer에서 XDP를 PDF으로 미리 보는 것과 동일한 XDP를 HTML으로 미리 보는 것은 서로 다른 동작을 경험합니다. NPR-28602: CQ-4260239용 핫픽스
...
* 빠른 검색에서 `(`, `+`, `?` 등의 문자를 검색하는 동안 오류가 발생했습니다. NPR-28212: CQ-4260969용 핫픽스
* API를 사용한 사용자 생성 콘텐츠에서 댓글을 삭제할 수 없습니다. NPR-28075: CQ-4260534용 핫픽스
* 다음 페이지에 게시된 댓글은 새 댓글이 게시되면 노란색으로 강조 표시됩니다. NPR-28148: CQ-4259681용 핫픽스
* Outlook 보낸 편지함 및 받은 편지함 폴더에 첨부 파일이 있는 메시지를 열 수 없습니다. NPR-28559: CQ-4217072용 핫픽스
...
* 콘텐츠 프레임이 editor.js에 로드된 후 `loaderPromises` 목록이 지워지지 않습니다. NPR-27768: CQ-4205337용 핫픽스
...
* 사용자가 콘텐츠 조각을 편집하려고 하면 페이지가 비어 있습니다. NPR-27669
* 사용자가 주석을 클릭하면 주석 강조 표시가 사라집니다. BPR-27196: CQ-4254423용 핫픽스

#### 통합 {#integration-1}

* ResourceResolver가 대상 구성 요소에 대한 여러 도메인을 확인하지 않습니다. NPR-28265: CQ-107847용 핫픽스
* 이제 작업이 표시되므로 LiveCopy 상속 취소가 타깃팅된 컨테이너에서 제대로 작동합니다. NPR-28129: CQ-4259813용 핫픽스

#### 복제 {#replication-1}

* DispatcherFlushRules가 6.3.3.1에서 복제를 중단했습니다. NPR-28150: CQ-4261401용 핫픽스
...
* 타겟 구성 요소 옵션은 기본 대상을 제외한 대상에 사용할 수 없습니다. CQ-4261370용 핫픽스
...
* 드롭다운 목록에서 항목을 추가하거나 제거해도 확인란 항목 선택 시 업데이트되지 않습니다. NPR-28224: CQ-4252834용 핫픽스
...
* 자산 폴더에서 폴더 메타데이터 스키마로 규칙 탭 및 그 시행에 대한 지원을 추가했습니다.
* 게시의 그룹 목록 페이지에 대한 페이지 매김 지원이 활성화되었습니다.
* 알림 unreadCount를 임의 수로 구성하도록 설정되었습니다. 기본값은 20으로 설정되어 있습니다.
* 외부 링크 확인의 수정 사항입니다.

#### 자산 {#assets-6}

* 동적 드롭다운 목록에서 계단식 드롭다운이 지원되지 않습니다. NPR-27044; CQ-4252564용 핫픽스
* ExpiryNotification 기능을 사용하도록 쿼리를 개선했습니다. NPR-26999: CQ-4251188용 핫픽스
* 규칙이 메타데이터 스키마에서 폴더 메타데이터 스키마로 이전됩니다. NPR-27771: CQ-4257737, CQ-4257735, CQ-4259822용 백포트
* 에셋 참조 조정에서 Sling ResourceCollections의 일부인 에셋에 대한 참조를 업데이트하지 못했습니다. NPR-26759: CQ-4252605용 핫픽스
...
* 기초 양식과 함께 핵심 구성 요소 양식을 사용할 때 Null 포인터 예외가 발생합니다. NPR-27333: CQ-4249176용 핫픽스
...
* 리치 텍스트 편집기가 여러 필드와 결합되면 발견되지 않은 TypeError: fieldAPI.getName이 함수 at foundation.js 오류가 발생합니다. NPR-27146: CQ-4253155, CQ-4259967용 핫픽스
* Safari 브라우저에서 라디오 단추를 클릭해도 포커스/커서가 리치 텍스트 편집기에 남아 있습니다. NPR-27144: CQ-4249635용 핫픽스
...
* Dynamic Media 구성 요소에서 중단점을 지정한 후에는 이미지가 표시되지 않습니다. CQ-4256168용 핫픽스
...
* SP3 패치를 적용한 후 콘텐츠 조각 모델에 대한 링크가 없습니다. CQ-4259029용 핫픽스

#### DAM - UI {#dam-ui}

* SP3를 설치한 후 폴더 메타데이터 스키마 UI가 중단됩니다. CQ-4257737용 핫픽스

#### 커뮤니티 {#communities-5}

* 게시할 때 그룹 목록에 대한 페이지 매김을 추가합니다. NPR-26953: CQ-4246525용 핫픽스
* 읽지 않은 횟수 알림은 21 이상으로 설정할 수 없습니다. NPR-27496: CQ-4252829용 핫픽스
* 사용자 구독 제한은 1000개로 제한됩니다. NPR-27615: CQ-4254689용 핫픽스
* 포럼에서 이미지(예: .pdf) 이외의 첨부 파일을 업로드할 때 오류가 관찰되었습니다. NPR-27375: CQ-4257753용 핫픽스
* 행 클릭 시 답글 링크가 작동하지 않습니다. NPR-24556: CQ-4256138용 핫픽스
...
* 지원 Scorm 리소스 완료 상태 레이블이 UI에 비어 있습니다. NPR-27152: CQ-4249994용 핫픽스
* **권한이 있는 사용자 허용**&#x200B;을 사용하도록 설정할 때 권한이 있는 구성원은 커뮤니티 구성원인 사용자에게만 작성할 수 있어야 합니다. NPR-27901: CQ-4251235용 핫픽스
...
* 페이지 속성에서 저장 및 닫기 는 Tomcat을 사용하는 AEM WAR의 적절한 페이지로 돌아가지 않습니다. NPR-27567: Granite-23671용 핫픽스

* 입력한 텍스트는 저장한 후 sourceEdit 기능을 통해 손실됩니다. CQ-4259273용 핫픽스
...
* AEM Forms 페이지에 잘못된 양식이 구성되고 &#39;양식이 페이지의 전체 너비를 포함&#39; 확인란이 선택되면 AEM Sites 컨테이너 구성 요소가 표시되지 않습니다. NPR-25972: CQ-4239287, CQ-4249133용 핫픽스
...
* 양식 빌더를 최신 Handlebars 버전으로 업그레이드했습니다.
* 대화 상자 모드에서 RTE의 구성 편집에 대한 구성 서블릿을 추가했습니다.
...
* 보관 해제 단계에서 생성된 아카이브를 %로 이름이 지정된 폴더로 압축 해제하면 열리지 않습니다. NPR-26275: CQ-4251482용 핫픽스
* 작은 따옴표를 사용하면 메타데이터 업데이트가 수행되지 않습니다. NPR-26808: CQ-4254305용 핫픽스
...
* 자산 링크 공유에서는 숫자 사용자 ID를 사용하는 내부 사용자를 두 명 이상 추가할 수 없습니다. NPR-26206: CQ-4251466용 핫픽스
...
* 정책은 편집 대화 상자의 리치 텍스트 편집기 기능을 제어하지 않습니다. NPR-27059, NPR-26750: CQ-4241130용 핫픽스
...
* &#39;특수 문자&#39;를 추가하면 리치 텍스트 편집기 대화 상자가 맨 위에 스크롤됩니다. NPR-26435: CQ-4249869용 핫픽스
...
* 구조화된 컨텐츠 조각 모델 태그 필드는 태그 이동 작업을 반영하지 않습니다. NPR-26801: CQ-4251805용 핫픽스
...
* (클래식 UI) 페이지 속성으로 돌아간 축소판 이미지는 더 이상 상속을 사용하지 않고 사이트 관리자 및 사이드 킥에서 사라지고 공백으로 표시됩니다. NPR-26562: CQ-4252346용 핫픽스
...
* 복제는 OAuth에 대해 만료된 토큰을 사용하므로 여러 오류가 발생합니다. NPR-25894: GRANITE-22388용 핫픽스
...
* 여러 복제 에이전트에 의한 동시 액세스는 액세스 토큰 노드에 액세스할 때 로그에 예외를 일으킵니다. NPR-26964: GRANITE-23276, Granite-23155용 핫픽스

#### ContextHub {#contexthub}

* `coral.js` 파일에 `handlebars.js` 라이브러리의 취약한 버전이 포함되어 있습니다. CQ-4255377용 핫픽스
...
* 포럼 게시물을 만들 때 첨부 파일 이미지에 썸네일이 표시되지 않습니다. NPR-26380: CQ-4253105용 핫픽스
* Word 플러그인에서 붙여 넣기가 두 개 이상의 이미지를 로드하지 못했습니다. NPR-26728: CQ-4253638용 핫픽스
* 관리 페이지에서 콘텐츠를 필터링할 수 없습니다. NPR-26697: CQ-4213766용 핫픽스
* (보안 취약성) 잘못된 JWT 구성으로 인해 계정이 도용되었습니다. NPR-26440: CQ-4253314용 핫픽스
* Adobe 저장소 리소스 공급자에서 데이터를 검색하는 데 속도가 느립니다. NPR-26237: NPR-24152용 핫픽스
* 비공개 메시지 구성 페이지가 불규칙하고 부진하다. NPR-26120: CQ-4250923용 핫픽스
...
* 포럼 구성 요소에서 검색할 때 문제가 발생합니다. NPR-26577: CQ-4251303용 핫픽스
* 커뮤니티 메시징에서 이름과 성을 함께 검색하면 예상 결과가 반환되지 않습니다. NPR-26377: CQ-4253150용 핫픽스
* 답글 제거 시 페이지 매김이 업데이트되지 않습니다. NPR-26327
* 게시물 삭제는 작동하지만 콘솔에 오류가 발생하고 게시물이 UI에 계속 표시됩니다. NPR-26292: CQ-4252803용 핫픽스
...
* 역할 설정에 그룹 및 구성원을 추가하고 블로그 기능에 권한이 있는 구성원을 허용하는 중 Null 포인터 예외가 발생했습니다. NPR-21732, NPR-27176: CQ-4255909용 핫픽스
* 사이트를 편집하고 역할 설정에서 멤버를 추가하면 null 포인터 예외가 발생합니다. NPR-27132: CQ-4255909용 핫픽스
...
* Document Security의 워터마크 설정을 만들거나 편집할 수 없습니다. NPR-26267, NPR-26129: CQ-4250234용 핫픽스
...
* 편집 가능한 모듈을 편집하고 저장한 다음 PDF 미리 보기를 열거나 닫으면 편지의 PDF 및 HTML 미리 보기가 계속 표시됩니다. 두 미리보기는 동일한 창에서 작동합니다. NPR-26770: CQ-4253217용 핫픽스

#### Forms - 워크플로 {#forms-workflow-2}

* 작업 영역이 간헐적으로 중단되고 시작 지점이 반복적으로 표시됩니다. NPR-26461: CQ-4253439용 핫픽스
* 작업 이름에 중괄호가 사용되는 경우 로그에서 ESAPI 예외가 발생합니다. CQ-4256627용 핫픽스
* 미리 채워지지 않은 적응형 양식 또는 양식 집합 관련 시작 지점을 열면 null 포인터 예외가 발생합니다. CQ-4256124용 핫픽스
...
* 관리자 UI에서 검색 템플릿을 설정한 다음 이를 사용하여 AEM Forms 작업 영역에서 검색할 때 예외가 발생합니다. CQ-4255649용 핫픽스
* 이름에 괄호 기호를 사용한 애플리케이션 아래의 프로세스 추적 세부 사항은 HTML Workspace에 표시되지 않습니다. CQ-4242101용 핫픽스
* Workspace HTML의 환경 설정 화면에 변경 사항을 저장하면 예외가 발생합니다. CQ-4241485용 핫픽스
* 대량 승인이 최신 JEE 설정에서 해제됩니다. CQ-4241486용 핫픽스
* 최신 6.4 JEE 서버에서 작업/시작 지점의 초안이 실패합니다. CQ-4241484용 핫픽스
* Date().getTime().toString 매개 변수를 설정하여 Date.toString() 대신 세션을 초기화합니다. CQ-4241483용 핫픽스
...
* WAS9에서 클래스 로더 리소스로 esapi.properties를 로드하지 못했습니다. CQ-4255631용 핫픽스
...
* PDFG의 정적 코드 분석 보고서에 보고된 문제가 해결되었습니다. NPR-23251: CQ-4213930용 핫픽스
...
* 다양한 첨부 파일 유형에 대해 가능한 모든 MIME 유형을 지원하도록 필드 유형 길이를 255로 변경했습니다.
* 이미지가 업로드 기준을 위반하는 경우 서버에서 구성된 오류 메시지입니다.
* 일별 CQ 메일 서비스에 STARTTLS 지원이 추가되었습니다.
* 최신 버전의 cq-wcm-content 및 com.adobe.cq.launches.it.serverside로 업데이트합니다.
* 릴리스된 최신 버전으로 com.adobe.granite.ui.coralui3-rte를 업데이트합니다.
* expressionResolver가 null인 경우 렌더링 조건이 올바른 결과를 반환하는지 확인했습니다.
...
* 표시되는 정보와 비교하여 다운로드 크기가 일치하지 않습니다. NPR-23418: CQ-4242774용 핫픽스
...
* 자산 관리자 검색 패싯은 미리 본 후 검색 패널에서 사라집니다. NPR-23964: CQ-4244410용 핫픽스
...
* Publish/Brand Portal에 게시 취소 단추는 콘텐츠 조각에 사용할 수 없습니다. NPR-23318: CQ-4245086용 핫픽스
* (Brand Portal) 자산이 게시될 때 하위 자산 만들기를 활성화합니다. NPR-23331: CQ-4242018용 핫픽스
* Dynamic Media 요청은 프록시/HTTP 공통 클라이언트를 사용하지 않습니다. NPR-10727: CQ-45695, CQ-88800용 핫픽스
...
* Dynamic Media 인코딩 비디오 문제 - 수정/재업로드 시작 관리자. NPR-23237: CQ-4240260용 핫픽스
* Dynamic Media S7에서 HTTP 전달자에 대한 프록시 처리 수정 사항입니다. NPR-24001: CQ-244140용 핫픽스

### 사이트 {#sites-8}

* 6.2와 6.3 사이의 다른 xPath 변환으로 인해 발생하는 Query Builder 불일치. NPR-23245: CQ-4240396용 핫픽스
* 페이지 속성의 썸네일 탭은 대화 상자를 확장하는 데 작동하지 않습니다. NPR-22844: CQ-4241474용 핫픽스
* Parsys가 에뮬레이터 디바이스 프레임 폭을 나누고 여기에 추가된 구성 요소를 자릅니다. NPR-22926: CQ-4238224용 핫픽스
* 여러 론치를 실행할 때 론치가 작성자에 홍보되지만 복제 권한 부족으로 인해 게시 서버에서 변경 사항이 복제되지 않습니다. NPR-22934: CQ-4234746용 핫픽스
* 다른 세션의 다른 사용자는 첫 번째 세션의 사용자가 잠근 페이지를 수정할 수 있습니다. NPR-23057: CQ-4199017용 핫픽스
* 목록 보기에서 순서 조정 가능 옵션을 수정합니다. NPR-23065: CQ-4239321용 핫픽스
* (페이지 편집기) 이미지 구성 요소의 이미지는 대화 상자를 다시 열 때 사라집니다. NPR-23156: CQ-4239978용 핫픽스
...
* XF 변형에 대한 블루프린트 탭에 롤아웃 버튼이 없습니다. NPR-23320: CQ-4240404용 핫픽스
* 사용 중단으로 인해 CUG를 클래식 UI에서 편집할 수 없습니다. NPR-24122: 4241823용 핫픽스
* 원치 않는 콘텐츠 홍보로부터 보호하기 위한 사전 대응형 수정 사항입니다. NPR-24387: 4244993용 핫픽스
* 약 Assets의 폴더에 80개의 조각이 추가되어 타임라인 콘솔에서 워크플로우를 트리거할 때 오류가 발생합니다. NPR-23393; CQ-4211216용 핫픽스
* 컨텐츠 파인더에서 이미지를 리치 텍스트 편집기 대화 상자로 드래그하여 놓을 수 없습니다. NPR-23403: CQ-4242094용 핫픽스
...
* 검색 패싯에서 태그 술어를 사용하는 경우 스마트 컬렉션은 저장 후 결과를 표시하지 않습니다. NPR-23401: Granite-21278용 핫픽스
* 보안 수정 사항을 포함하는 clientlib의 jQuery 1.12.4 패치입니다. NPR-24128: Granite-20058용 핫픽스
* 이제 번들을 다시 시작하면 다국어화 번역이 업데이트됩니다. NPR-23193: Sling-7190용 핫픽스
...
* 중간 폴더 구조로 구성 참조 복제가 실패합니다. NPR-23485: CQ-4242751용 핫픽스
...
* 언어 사본을 만드는 동안 라이브 카피 속성은 삭제되지 않습니다. NPR-23123: CQ-4230641용 핫픽스

### 사용자 인터페이스 {#user-interface-1}

* DatePicker는 숨겨진 필드에 설정된 외부 유형 힌트를 수동으로 설정할 수 없습니다. 이 유형 힌트를 변경하면 변환 오류가 발생합니다. NPR-23371: Granite-21194용 핫픽스
* Coral.ColumnView: shift+클릭을 추가로 지원합니다. NPR-23404: Granite-13338용 핫픽스
* 값이 비어 있는 항목을 선택하면 RT가 유효성 검사를 하지 않음 을 선택합니다. NPR-23405: Granite-21283용 핫픽스
...
* 커뮤니티 검색은 몇 마디 단어로 인해 실패하고 있습니다. NPR-23256: CQ-4240717용 핫픽스
...
* (ContextPath) 커뮤니티 그룹 구성원 목록에서 그룹 구성원을 검색하는 동안 Jetty 구성 및 오류에 대해 메시지 깨짐 기능이 중단됩니다. NPR-23336: CQ-4241519, CQ-4242080용 핫픽스
...
* 플래그가 지정되지 않은 사용자의 플래그 이유는 계속 표시됩니다. NPR-23974: CQ-4243822용 핫픽스
...
* 처리 후 또는 정기적으로 작업자 인스턴스에서 자산을 정리하는 메커니즘을 요청합니다. NPR-23638: Granite-21337용 핫픽스
...
* 숫자 필드는 최소값을 준수하지 않습니다. NPR-23967: CQ-4244830용 핫픽스
...
* TIFF 파일(약 50KB 크기)을 동시에 처리하는 동안 Paper Capture 서비스가 중단됩니다. NPR-23556
...
* 문자 집합 수정 사항을 포함하도록 Sling 모델 번들을 업데이트했습니다.
...
* UI에 &quot;Publish에서 Brand Portal으로 실패&quot;라는 잘못된 오류가 표시되지만, 작업이 복제 큐에 추가되고 자산이 Brand Portal에 게시됩니다. NPR-22179: CQ-4205273용 핫픽스
* (Touch UI) 열 보기의 자산에 대한 기본 업로드 위치입니다. NPR-22465: CQ-4237057용 핫픽스
* AEM에서 자산 스키마를 `/conf/global`에서 `/conf/mytenant`(으)로 복사하려고 할 때 StackOverflow 오류가 발생합니다. NPR-22489: CQ-4235875용 핫픽스
...
* HTTP 504: 공유 링크를 사용하여 컬렉션을 공유하려고 할 때 게이트웨이 시간 초과 오류 발생. NPR-21928: CQ-4234507용 핫픽스
* PDF 자산과 연관된 키워드가 여러 개 있는 경우 PDF 키워드 메타데이터가 제대로 추출되지 않고 잘못 수정됩니다. 이 문제를 해결하기 위해 PDF 자산에 대한 제목 필드 메타데이터 속성이 제거되었습니다. 하지만 메타데이터 스키마를 편집하여 제목 필드에 대한 다중 값 텍스트 필드를 추가할 수 있습니다. NPR-21972: 4215741용 핫픽스****
...
* Safari의 자산에서 Digital Rights Management를 사용할 때 자산 다운로드가 실패합니다. 사용자가 면책조항이 있으며 긴 파일 이름을 사용하는 에셋을 다운로드할 수 없습니다. NPR-22747: CQ-4236460 및 CQ-4235274용 핫픽스
* Brand Portal에 자산을 게시하는 동안 공개 공유를 기본 옵션으로 설정합니다. NPR-21931: CQ-4218816용 핫픽스

### 사이트 {#sites-9}

* 워크플로우 받은 편지함의 새 항목에 페이지 제목 대신 페이지 경로가 표시됩니다. NPR-21634: CQ-4230672용 핫픽스
* 편집 가능한 구조 구성 요소를 편집할 때 응답형 격자에 필요한 CSS 클래스 이름이 손실됩니다. NPR-21741: CQ-4232374용 핫픽스
* (TouchUI) HTL 구성 요소에 대한 여러 XSS(교차 사이트 스크립팅) 취약성이 있습니다. NPR-21899: CQ-4232511용 핫픽스
* 콘텐츠 조각 혼합 미디어 이미지 리소스 유형을 변경할 수 없습니다. NPR-21907: CQ-4233401용 핫픽스
* Touch UI 대화 상자의 RTE 전체 화면에서 RTE 플러그인을 숨깁니다. NPR-22034: CQ-4235457용 핫픽스
...
* 텍스트가 비어 있을 때 TreeNode를 name 속성으로 되돌립니다. NPR-22146: CQ-4234724/CQ-4236300용 핫픽스
...
* 텍스트를 입력할 때 태그 필드의 필터링이 예상대로 작동하지 않습니다. NPR-22236: CQ-4236655용 핫픽스
...
* ContextHub 저장 시 지속성 문제가 초기화 중에 기본 지속성 레이어를 덮어씁니다. NPR-22479: CQ-4218399용 핫픽스
* 첫 번째 콘텐츠 루트에서 &quot;하위 페이지 포함&quot;이 선택되어 있지 않은 경우 여러 페이지로 구성된 Launch는 하위 페이지를 게시 서버에 게시하지 않습니다. NPR-22482: CQ-4237818용 핫픽스
* (Touch UI) 클래식 UI 콘솔을 통해 론치를 삭제하면 모든 페이지를 편집할 수 없습니다. NPR-22491: CQ-4225074용 핫픽스
* 대화 상자의 추가 공간으로 인해 이미지 구성 요소 관련 문제가 발생합니다. NPR-22528: CQ-4238183용 핫픽스
* 인라인 모드를 사용하여 구성 요소를 여는 동안 이전에 로드된 플러그인이 두 번째로 표시되지 않습니다. NPR-22591: CQ-4236850용 핫픽스
...
* 페이지의 이미지 구성 요소에 추가된 이미지를 뒤집으면 변경 사항이 저장되지 않고 원래 이미지가 페이지에 표시됩니다. 렌더링 지원이 [https://github.com/adobe/aem-core-wcm-components/pull/141](https://github.com/adobe/aem-core-wcm-components/pull/141)을 통해 이미지 코어 구성 요소에 추가되었습니다. NPR-22801: CQ-4221539용 핫픽스
* 사용자가 앵커 메뉴에서 기존 앵커를 삭제하려고 하면 리치 텍스트 편집기 구성 요소 창이 닫히고 변경 사항이 저장되지 않은 상태로 유지됩니다. NPR-22802: CQ-4238167용 핫픽스
* Omnisearch 필터는 사이트 콘솔에 모든 작업을 표시하지 않습니다. NPR-22804: CQ-4239007용 핫픽스
...
* 의 게시 인스턴스가 있는 페이지를 활성화하면 황색으로 바뀌는 대신 녹색 상태가 표시됩니다. NPR-22927: CQ-4236310용 핫픽스
* (StyleSystem) 팝업에서 스타일을 선택하는 동안 화면 위치가 이동합니다. NPR-23183: CQ-4238867용 핫픽스
* (게시 관리) 달력의 다음 달로 이동하려면 여러 번 클릭해야 합니다. NPR-23508: CQ-4242732용 핫픽스

### 플랫폼 {#platform-2}

* Sling 내보내기 서블릿에서 일본어 문자를 올바르게 내보내지 않습니다. NPR-22153: CQ-4228920용 핫픽스
...
* Target 엔진(mbox.js, at.js)은 훼손된 URL을 사용하지 않습니다. 및 은 특정 배포에서 실패할 수 있는 콜론이 포함된 URL을 사용합니다. NPR-22366: CQ-4237854용 핫픽스
* 사용자 지정 at.js 또는 mbox.js를 제공하면 포함된 스크립트가 HTML 태그 대신 텍스트로 페이지에 기록됩니다. NPR-22441: CQ-4203691용 핫픽스
* 대상 모드에서 작성자가 상속을 취소하지 않고도 블루프린트에서 상속된 구성 요소를 수정할 수 있습니다. NPR-22751: CQ-4237907용 핫픽스
* `jcr:content` 노드가 누락되어 PersonalizationDataSource에 null 포인터 예외가 발생합니다. NPR-22850: CQ-4222122용 핫픽스
* 비영어 언어를 사용할 때 AEM 타깃팅이 실패합니다. NPR-22917: CQ-4218213용 핫픽스
...
* 상속 취소/비활성화 확인란을 선택 취소하면 iParsys가 위치 이동을 생성합니다. NPR-21905: CQ-4230951용 핫픽스
* 양식 드롭다운 구성 요소의 기능 표시/숨기기 기능이 예상대로 작동하지 않습니다. NPR-22327: CQ-4222853용 핫픽스
* CAPTCHA 구성 요소는 더 나은 보안을 위해 더 이상 사용되지 않습니다. CAPTCHA 구성 요소를 사용하는 경우 6.3.2.1 이상 릴리스를 설치하면 &quot;Captcha 구성 요소는 더 이상 사용되지 않으며 더 이상 사용해서는 안 됩니다&quot;라는 메시지가 표시됩니다. 보안 강화를 위해 reCAPTCHA를 포함하도록 AEM 구성 요소를 사용자 정의할 수 있습니다. NPR-22151: CQ-4220052용 핫픽스
...
* LogbackManager는 시작할 때 일부 OSGi 구성을 놓칠 수 있습니다. NPR-23060: Granite-19791용 핫픽스

### 상거래 {#commerce-3}

* 경험 조각 메뉴에서 워크플로우 만들기를 활성화합니다. NPR-22347: CQ-4221661용 핫픽스
...
* PDF/A-2a 또는 PDF/A-3a를 준수하는 PDF 파일을 생성하는 지원이 추가되었습니다.

### Forms 추가 기능 패키지 {#forms-add-on-package-9}

#### Forms-관리자 UI {#forms-admin-ui}

* ECM Connectors 구성 페이지에서 암호 필드를 검사할 때 암호는 일반 텍스트로 표시됩니다. NPR-22508: CQ-4236065용 핫픽스
...
* 규칙 편집기의 사용자 지정 함수에서 함수 호출 뒤에 추가 함수를 추가하고 있습니다. 따라서 사용자 지정 함수가 true를 반환해도 유효성 검사가 실패합니다. NPR-22481: CQ-4235499용 핫픽스
* 선택한 날짜 패턴과 관계없이 최소 및 최대 유효성 검사 메시지를 표시할 때 날짜 선택기 구성 요소가 패턴을 따르지 않습니다. NPR-22444: CQ-4236269용 핫픽스
* 제출 요청에서 전송되는 날짜 형식은 날짜 선택기 구성 요소에 제공된 패턴과 일치해야 합니다. NPR-22384
* 적응형 양식 텍스트 상자에 지정된 최대 문자 수가 Android™ 6.0 Samsung 디바이스에 적용되지 않습니다. NPR-22363, NPR-22364: CQ-4235205용 핫픽스
* (Microsoft® Edge) (IE11) 다중 라인 필드가 있는 적응형 양식 텍스트 필드 구성 요소에 공백이 아닌 `Null`이(가) 기본값으로 표시됩니다. NPR-22284: CQ-69107용 핫픽스
* 적응형 양식의 SOAP UTF-8 입력 인코딩이 잘못된 페이지의 오류를 반환합니다. NPR-20105: CQ-4222669용 핫픽스
* AEM Forms 페이지에 잘못된 양식이 구성되면 AEM Sites 컨테이너 구성 요소를 편집할 수 없습니다. CQ-4237456용 핫픽스
* JEE 서버에서 실행할 때 개발 테스트가 실패했습니다. CQ-4222082용 핫픽스
* Calvin 프레임워크의 축소 문제로 인해 JEE 서버에서 AF 테스트가 실패했습니다. CQ-4217220용 핫픽스
...
* 페이지를 게시한 후 수정된 Forms은 다시 게시되지 않습니다. NPR-23013: CQ-4236566용 핫픽스
...
* (HTML Workspace) 작업 공간에서 양식을 닫을 때 데이터 준비가 트리거됩니다. NPR-21127: CQ-4224574용 핫픽스
* (HTML 작업 공간) 긴 설명이 있는 메모가 필요한 프로세스를 호출할 때 메모 확장 버튼이 작동하지 않습니다. CQ-4241488용 핫픽스

#### 코어 {#core-1}

* 스케줄러를 시작하는 중 시작 시 오류가 발생합니다. NPR-22990
* 브라우저에서는 HTML 양식에 입력한 자격 증명을 저장할 수 없습니다. NPR-21762: CQ-4206543용 핫픽스
...
* PDF/A-2a 또는 PDF/A-3a를 준수하는 PDF 파일을 생성하는 지원이 추가되었습니다. NPR-23021: CQ-4214172용 핫픽스

#### Forms Designer {#forms-designer-1}

* Designer에서 PDF으로 저장할 때 PDF/UA 식별자가 없습니다. NPR-23137
...
* Designer에 정의된 인라인 하이퍼링크는 Designer에서 PDF으로 저장할 때 태그가 지정되지 않거나 대체 텍스트가 있습니다. NPR-23133
...
* HSM을 통해 PDF 문서에 디지털 서명하는 동안 예외가 발생했습니다. NPR-21154: CQ-4226978용 핫픽스
...
* 라이선스 확인 페이지에서 공백이 있는 에셋을 다운로드할 수 없습니다. NPR-20067: CQ-4216557용 핫픽스
* 여러 알파 레이어가 있는 PSB 파일을 업로드할 때 처리 문제가 발생합니다. NPR-20250: CQ-4220869용 핫픽스
* 사용자가 긴 파일 이름 및 면책조항이 정의된 에셋을 다운로드할 수 없습니다. NPR-20254
* ProductAssetsUploader가 Java™ 캐시의 임시 파일을 Java™ TEMP 폴더에 둡니다. NPR-20256: CQ-4221801용 핫픽스
...
* AEM Dynamic Media Classic(이전의 Scene7)가 AEM 서버의 자산을 동기화하지 못합니다. 이 문제는 Cloud Service 구성의 대상 경로가 루트 경로 하위 폴더를 가리킬 때 발생합니다. CQ-4228265
...
* 게시 관리를 통해 페이지를 게시할 때 알림 상자에 입력된 워크플로우 이름을 사용할 수 있어야 합니다. NPR-20046: CQ-4221586용 핫픽스
...
* 서식 있는 텍스트 플러그인이 multifield Touch UI의 인라인 및 전체 화면 막대에 대해 작동하지 않습니다. NPR-20973
...
* 커뮤니티 사이트를 만든 후에는 컨텍스트 경로가 URL 앞에 추가되지 않으므로 사이트 맵에서 열 수 없습니다. NPR-20730
...
* TXT 유형의 에셋에 대한 메타데이터 속성은 속성이 표시될 때마다 다른 메타데이터 편집기에 표시됩니다. NPR-20239
...
* 이제 다른 data-sly-resource 문에 대해 requestAttributes가 설정되지 않았습니다. NPR-20639: 4226206용 핫픽스
* AEM의 OOTB 자산에 대한 curl Head 요청 문제가 수정되었습니다. NPR-20781: CQ-4221520용 핫픽스

### 프로젝트 {#projects-1}

* 프로젝트 콘솔에서 다른 프로젝트에 액세스하면 로드하는 데 시간이 더 오래 걸립니다. NPR-20314
* AEM 6.3.0.1을 설치하면 `dam-update-service` 사용자의 키 저장소가 제거됩니다. NPR-20018
* 일부 사용자 지정 배포에서는 addTask 모듈에서 할당자를 선택하려는 사용자가 사용자 선택기의 목록을 채우는 데 시간이 더 오래 걸립니다. NPR-20283: CQ-4224193용 핫픽스

### 사용자 인터페이스 {#user-interface-3}

* 색상 필드는 대화 상자의 속성에도 불구하고 &quot;항상 필수&quot;로 설정됩니다. NPR-19702
...
* 연결된 양식 데이터 모델 서비스가 값을 반환하지 않는 경우에도 드롭다운에 마지막으로 저장된 값이 표시됩니다. NPR-20710
...
* Switch 구성 요소의 값을 true 또는 false 로 설정할 수 없습니다. NPR-21111
...
* 하위 양식과 같은 XDP 양식 개체의 이름은 액세스 가능성 구성에 정의되어 있지 않을 때 해당 도구 설명으로 표시됩니다. NPR-20523
...
* 기본 메타데이터 스키마 양식에 대해 Brand Portal에 게시 작업을 활성화했습니다.
* dc: 제목 속성이 `String [] (multifield)`(으)로 설정된 이미지에 대한 이미지 카드의 제목을 표시할 때 동작이 변경되었습니다.
* 시간의 서버측 렌더링을 기본 시간 구성 요소로 대체했습니다.
* tagadmin/tagging 콘솔에서 AEM에서 Brand Portal으로 태그를 게시하도록 설정했습니다.
* 콘텐츠 조각을 사용하도록 JSON API를 게시했습니다.
* 내장된 저장소(Apache Jackrabbit Oak)가 버전 1.6.5으로 업데이트되었습니다.

### 자산 {#assets-11}

* 속성 유형이 다른 동일한 두 필드를 매핑하면 내부 오류가 발생합니다. NPR-19462: CQ-4216828용 HF
...
* 구성 마법사의 타깃팅 엔진 필드가 Adobe Target이 아닌 AEM(ContextHub)로 설정되어 있습니다. NPR-19320: CQ-4218465용 HF
* 경험을 만드는 동안 대상자 섹션이 손상됩니다. NPR-19110
...
* WCMMode.EDIT은 작성 모드에서 타깃팅된 구성 요소에 대해 작동하지 않습니다. NPR-19387
* 콘텐츠 조각을 사용하도록 JSON API를 게시했습니다. NPR-19500
* 작성자 대화 상자의 리치 텍스트 편집기 필드에는 굵게, 기울임꼴, 밑줄 기능이 작동하지 않습니다. NPR-19670: NPR-19718: CQ-4219088용 핫픽스

### 모바일 온디맨드 {#mobile-on-demand-1}

* 전체 크기 이미지를 사용할 때 AEM 문서 콘솔의 문제를 렌더링하면 속도가 느려집니다. NPR-19088
...
* AEM 6.3으로 업그레이드한 후 스크립트로 구현된 태그를 참조하는 사용자 지정 태그 라이브러리를 찾을 수 없습니다. NPR-19087
...
* XF 변형 편집기를 선택한 후 워크플로우 시작 단추는 영향을 주지 않습니다. NPR-19642: CQ-4207796용 핫픽스

### 프로젝트 {#projects-2}

* 프로젝트 편집기에서 프로젝트 자산 폴더에 자산을 복사하여 붙여넣을 수 없습니다. NPR-19619: CQ-4215321용 핫픽스

### 웹 콘텐츠 관리 {#web-content-management}

* 롤아웃 화면에서 라이브 카피 페이지에 해당하는 확인란은 선택하거나 선택 취소할 수 없습니다. NPR-19518
...
* Google Chrome 브라우저를 사용하는 경우, 사용자가 TouchUI의 열 보기를 사용하여 전체 페이지/에셋 목록을 로드할 수 없습니다. NPR-19566: CQ-4214248용 핫픽스

### Brand Portal {#brand-portal-1}

* 댓글 및 주석과 함께 AEM의 자산을 게시할 수 없습니다. NPR-19590: CQ-4218386용 핫픽스
* tagadmin/tagging 콘솔에서 AEM에서 Brand Portal으로 태그를 게시하도록 설정합니다. NPR-20271: CQ-4223948용 핫픽스
...
* JEE에 제출 워크플로우에서는 출력 매개 변수를 JEE측에서 AEM으로 반환하지 않고 &quot;값이 기본 값이 아니므로 무시&quot; 오류가 발생합니다. NPR-20265
* 적응형 양식은 Safari에서 PDF를 첨부 파일로 허용하지 않습니다. NPR-19625
* RestoreGuideState가 customcontextproperty 맵을 덮어씁니다. CQ-4222877
* 외부 연결을 위해 org.apache.http.proxyconfigurator를 구성해야 하는 환경에서 Cloud Service을 사용하여 Google `reCaptcha`을(를) 구성할 때 POST 호출이 PROXY를 거치지 않는 것 같습니다. NPR-20454
* XSD 스키마 기반의 적응형 Forms은 마침표(.) 이외의 소수 구분 기호가 있는 로케일이 설치된 설치의 숫자 필드에 대해 잘못된 XML 값을 제출합니다 오류가 발생합니다. NPR-20444
* 타사 서버에 대한 HTTP 요청을 하는 동안 &#39;Apache HTTP 구성 요소 프록시 구성&#39;에 대해 설정된 프록시 설정이 적용되지 않습니다. HTTP GET 또는 POST 호출 사용 시 연결 제한 시간 문제가 발생합니다. NPR-20457, NPR-20456, NPR-20455, NPR-20451
...
* 양식이 최대화/최소화되어 초안으로 저장되거나 전달된 경우 작업 공간에서 워크플로우 첨부 파일, 메모 및 세부 사항 탭이 작동하지 않습니다. NPR-20243
* 여러 줄 텍스트 필드(TextArea)는 HTML Workspace에서 데이터를 제출한 후 텍스트에 줄 문자 또는 줄바꿈을 새로 유지하지 않습니다. NPR-20085

#### 프로세스 보고 {#process-reporting}

* null 포인터 예외로 인해 프로세스 보고에서 데이터를 제대로 가져오지 않습니다. NPR-19759

>[!NOTE]
>
>문제를 해결하려면 [AEM Forms 릴리스](aem-forms-releases.md) 문서에 나열된 LiveCycle 포함 패키지를 설치하십시오.
...
* 에셋에 대한 필수 필드 유효성 검사가 누락되었으므로 드롭다운 메타데이터 스키마 필드를 필수 필수로 지정할 수 없습니다. NPR-17882: CQ-4208373용 FP
...
* 해결된 콘텐츠 조각 유효성 검사 문제
* 하이브리드 디바이스에서 메타데이터 스키마 편집성 개선
...
* 일본어 폴더 아래의 에셋에 대한 검토 작업이 작동하지 않습니다. CQ-4204782
* 속성 페이지에서 자산을 이동할 때 null 포인터 예외가 발생합니다. CQ-4204251
* 자산이 InDesign 문서에 여러 번 연결되는 경우 AEM은 속성 페이지에서 해당 자산에 대한 후속 참조를 추적하지 못합니다. CQ-4204186
* 하이브리드 디바이스의 Chrome에서 편집할 때 메타데이터 스키마 양식에 새 탭을 추가하는 데 문제가 있습니다. CQ-4201810
* 중복 에셋이 업로드되면 검색된 중복 항목 대화 상자에서 선택하지 않은 경우에도 모든 에셋에 (삭제/유지) 옵션이 적용됩니다. CQ-4201673
...
* 앱에 대한 읽기 전용 권한이 있는 사용자는 AEM Mobile 컨텐츠 관리에서 컨텐츠를 미리 볼 수 없습니다. NPR-17486: CQ-4209690용 CFP
...
* 상속이 LiveCopy에서 다시 적용되면 수정한 현지화된 구성 요소가 원래 양식으로 복원되지 않습니다. NPR-18172: CQ-4211379용 핫픽스
...
* 페이지 이름은 긴 페이지 제목의 경우 규칙에 따라 생성되지 않습니다. NPR-17633: CQ-4209056용 핫픽스
* JBoss® EAP 6.4에 배포된 AEM 6.3의 Touch UI에서 페이지 작성과 관련된 문제가 발생합니다. NPR-17589: CQ-4210137 핫픽스
* 워크플로 상태 공급자는 중첩된 그룹이 있을 때 인스턴스를 잠급니다. NPR-17556: CQ-4202056에 대한 CFP 요청
...
* 받은 편지함에서 작업을 편집할 때 구문 분석할 수 없는 날짜 오류가 발생합니다. CQ-4208749
...
* 서신 관리 텍스트 모듈, 편지 미리 보기 및 서신 관리 UI를 만들기 위한 프로그래밍 방식 실행의 수정 사항.
* PDF/A-1b 유효성 검사, 큰 이미지 파일을 PDF로 변환, PDF 생성기의 일본어 PDF 문서에 대한 수정 사항입니다.
* 서신 관리, 문서 보안 및 Forms Workflow에 대한 유용성 수정 사항.
...
* 서신 관리 편지를 작성할 때 편지에 대한 설명이 저장되지 않습니다. NPR-18089
* 글머리 기호 목록 위와 아래에 있는 추가 여백은 텍스트 편집기에 표시되지만, HTML 및 PDF 렌디션에는 표시되지 않습니다. NPR-18126
...
* PDF Generator 서비스가 100MB가 넘는 이미지를 PDF 문서로 변환하지 못했습니다. CQ-4208628
* 일본어 OCR과 함께 PDF Generator 서비스를 사용할 때 반전 PDF이 생성됩니다. NPR-17602
...
* 다음 영역이 개선되었습니다.
   ...
   * 콘텐츠 조각, 사이트 및 리치 텍스트 편집기, 규칙 편집기 및 템플릿 편집기 구성 요소
...
>[!NOTE]
>
>Adobe에서 제공하는 선택적 기능 팩은 릴리스 버전 및 누적 수정 팩에 종속되어 있습니다. 기능 팩이 설치되어 있는 경우 [AEM 고객 지원팀](https://experienceleague.adobe.com/?support-solution=General#support)에 문의하여 이 AEM 6.3용 누적 수정 팩과의 호환성을 확인하십시오.

>[!NOTE]
>
>Adobe은 패키지 설치를 시도하기 전에 모든 새 설치 패키지에서 유효성 검사를 실행할 것을 권장합니다. 사전 유효성 검사는 설치 전에 발견된 모든 오류를 분석 및 보고하고, 그러한 오류에 대해 사전에 사용자에게 경고합니다.
>
...
* AEM 6.3.3.0은 CFP를 위한 필수 구성 요소입니다. AEM 설치를 AEM 6.3으로 업그레이드하는 방법에 대한 자세한 지침은 [업그레이드 설명서](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)를 참조하십시오.
...
* 다음 오류 및 경고는 AEM CFP 6.3.3.x 설치 중에 발생할 수 있으며, 무시해도 됩니다.
   ...
   * org.apache.sling.engine.impl.SlingRequestProcessorImpl ServletResolver 서비스가 누락되어 요청을 처리할 수 없으며 상태 503을 보냅니다.
...
* 6.3.1.2 이상에서 스마트 컬렉션에 대한 Brand Portal에서 Publish 단추가 제거되었습니다.
...
>[!NOTE]
>
>이 구성 설정은 6.3.2.2 이상에 적용됩니다. &quot;merge_preserve&quot; acHandling으로 인해 ACL은 CFP를 통해 업데이트되지 않으므로 CRX-DE를 통해 수동으로 ACL(액세스 제어 목록) 정책을 업데이트하도록 안내합니다.
...
&quot;/content&quot; 경로의 `1)`
`a)` 사용자 : reference-adjustment-service
유형 : 허용
권한 : jcr:read, jcr:modifyProperties
Restrictions : rep:glob=&quot;/&#42;/jcr:content&quot;
`b)` 사용자 : reference-adjustment-service
유형 : 허용
권한 : jcr:read, jcr:modifyProperties
...
기본값은 1입니다. `CQ.PAGE_PROPERTIES_MAX_RECURSION_LEVEL` 속성의 주석을 해제한 constants.js(`/libs/cq/ui/widgets/source/constants.js`) 파일을 오버레이하여 값을 재정의합니다. 그런 다음 필요한 값(페이지 속성 데이터가 저장되는 페이지 `/jcr:content` 아래의 최대 깊이)을 할당합니다.

**페이지의 `/jcr:content` 노드 아래의 노드 수가 1000개를 초과하도록 여러 페이지 변형을 만들어야 하는 경우 다음 단계를 사용하여 구성을 변경합니다.**

* Apache Sling의 속성 JSON 최대 결과를 구성합니다.
* `/system/console/ configMgr`을(를) 사용하여 서블릿을 가져옵니다.
...
6.3.3.8용 Uber Jar는 Adobe Public Maven 저장소에서 사용할 수 있습니다

Maven 프로젝트에서 Uber Jar를 사용하려면 [Uber Jar 사용 방법](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)을 참조하여 프로젝트 POM에 다음 종속성을 포함하십시오.
...
| 영역 | 기능 | 대체 | 버전 |
|----|-----|-----|-----|
| Assets과 Adobe Creative Cloud 통합 | [AEM과 Creative Cloud 폴더 공유](https://experienceleague.adobe.com/ko/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)는 Creative 사용자에게 AEM의 자산에 대한 액세스 권한을 제공하는 방법으로 AEM 6.2에 도입되었습니다. Creative Cloud 애플리케이션인 에셋 링크 Adobe에 릴리스된 새로운 기능으로 더 나은 사용자 경험을 제공합니다. 또한 Photoshop, InDesign 및 Illustrator 내부에서 AEM의 자산에 직접 보다 강력한 액세스를 제공합니다.</br></br> Adobe는 폴더 공유 기능에 대한 추가 개선을 하지 않습니다. 고객은 AEM에 해당 기능이 포함된 동안 교체를 사용해 보시기 바랍니다. | Adobe Asset Link 또는 데스크탑 앱. 자세한 내용은 [AEM Creative Cloud 통합](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions) 문서를 참조하십시오. | AEM 6.3.3.x |
...
>[!MORELIKETHIS]
>
>* [AEM 릴리스 및 업데이트](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates)
>* [AEM 6.3 핫픽스 페이지](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/aem-releases-updates)
>* [AEM 6.3 릴리스 정보](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)
>* [AEM 제품 페이지](https://business.adobe.com/products/experience-manager/adobe-experience-manager.html)
>* [AEM 6.3 설명서](https://experienceleague.adobe.com/en/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions)
